...
pub fn serialize(json: &str) -> Result<GangplankJson,Error>{
...
pub struct GangplankJson {
    #[serde(rename = "type")]
    pub gangplank_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "GangplankE.png")]
    GangplankEPng,
    #[serde(rename = "Gangplank_Passive.png")]
    GangplankPassivePng,
    #[serde(rename = "Gangplank.png")]
    GangplankPng,
    #[serde(rename = "GangplankQWrapper.png")]
    GangplankQWrapperPng,
    #[serde(rename = "GangplankR.png")]
    GangplankRPng,
    #[serde(rename = "GangplankW.png")]
    GangplankWPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "GangplankARAM")]
    GangplankAram,
    #[serde(rename = "GangplankCS")]
    GangplankCs,
    #[serde(rename = "GangplankFIRSTBLOOD")]
    GangplankFirstblood,
    #[serde(rename = "GangplankKINGPORO")]
    GangplankKingporo,
    #[serde(rename = "GangplankSIEGE")]
    GangplankSiege,
    #[serde(rename = "GangplankSL")]
    GangplankSl,
    #[serde(rename = "GangplankSR")]
    GangplankSr,
    #[serde(rename = "GangplankTT")]
    GangplankTt,
}
