...
pub fn serialize(json: &str) -> Result<LucianJson,Error>{
...
pub struct LucianJson {
    #[serde(rename = "type")]
    lucian_json_type: GroupEnum,
    format: Format,
    version: Version,
    data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "LucianE.png")]
    LucianEPng,
    #[serde(rename = "Lucian_Passive.png")]
    LucianPassivePng,
    #[serde(rename = "Lucian.png")]
    LucianPng,
    #[serde(rename = "LucianQ.png")]
    LucianQPng,
    #[serde(rename = "LucianR.png")]
    LucianRPng,
    #[serde(rename = "LucianW.png")]
    LucianWPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "LucianARAM")]
    LucianAram,
    #[serde(rename = "LucianCS")]
    LucianCs,
    #[serde(rename = "LucianFIRSTBLOOD")]
    LucianFirstblood,
    #[serde(rename = "LucianKINGPORO")]
    LucianKingporo,
    #[serde(rename = "LucianPRJ17")]
    LucianPrj17,
    #[serde(rename = "LucianSIEGE")]
    LucianSiege,
    #[serde(rename = "LucianSL")]
    LucianSl,
    #[serde(rename = "LucianSR")]
    LucianSr,
    #[serde(rename = "LucianTT")]
    LucianTt,
}

#[derive(Serialize, Deserialize)]
pub enum CooldownBurn {
    #[serde(rename = "110/100/90")]
    The11010090,
...
pub enum Effect {
    ...
    #[serde(rename = "{{ e2 }} -> {{ e2NL }}")]
    EffectE2E2Nl,
    #[serde(rename = "{{ numshots }}->{{ numshotsNL }}")]
    EffectNumshotsNumshotsNl,
    #[serde(rename = "%{{ e2 }} -> %{{ e2NL }}")]
    FluffyE2E2Nl,
    #[serde(rename = "{{ numshots }} -> {{ numshotsNL }}")]
    NumshotsNumshotsNl,
