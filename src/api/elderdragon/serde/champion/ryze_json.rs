...
pub fn serialize(json: &str) -> Result<RyzeJson,Error>{
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "RyzeE.png")]
    RyzeEPng,
    #[serde(rename = "Ryze_P.png")]
    RyzePPng,
    #[serde(rename = "Ryze.png")]
    RyzePng,
    #[serde(rename = "RyzeQWrapper.png")]
    RyzeQWrapperPng,
    #[serde(rename = "RyzeR.png")]
    RyzeRPng,
    #[serde(rename = "RyzeW.png")]
    RyzeWPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "RyzeARAM")]
    RyzeAram,
    #[serde(rename = "RyzeBT")]
    RyzeBt,
    #[serde(rename = "RyzeCS")]
    RyzeCs,
    #[serde(rename = "RyzeFIRSTBLOOD")]
    RyzeFirstblood,
    #[serde(rename = "RyzeKINGPORO")]
    RyzeKingporo,
    #[serde(rename = "RyzeSIEGE")]
    RyzeSiege,
    #[serde(rename = "RyzeSL")]
    RyzeSl,
    #[serde(rename = "RyzeSR")]
