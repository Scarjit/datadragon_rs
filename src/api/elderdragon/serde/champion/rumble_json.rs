...
pub fn serialize(json: &str) -> Result<RumbleJson,Error>{
...
pub struct RumbleJson {
    #[serde(rename = "type")]
    pub rumble_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "RumbleCarpetBomb.png")]
    RumbleCarpetBombPng,
    #[serde(rename = "RumbleFlameThrower.png")]
    RumbleFlameThrowerPng,
    #[serde(rename = "RumbleGrenade.png")]
    RumbleGrenadePng,
    #[serde(rename = "Rumble_JunkyardTitan1.png")]
    RumbleJunkyardTitan1Png,
    #[serde(rename = "Rumble.png")]
    RumblePng,
    #[serde(rename = "RumbleShield.png")]
    RumbleShieldPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "RumbleARAM")]
    RumbleAram,
    #[serde(rename = "RumbleCS")]
    RumbleCs,
    #[serde(rename = "RumbleFIRSTBLOOD")]
    RumbleFirstblood,
    #[serde(rename = "RumbleKINGPORO")]
    RumbleKingporo,
    #[serde(rename = "RumbleSIEGE")]
    RumbleSiege,
    #[serde(rename = "RumbleSL")]
    RumbleSl,
    #[serde(rename = "RumbleSR")]
    RumbleSr,
    #[serde(rename = "RumbleTT")]
    RumbleTt,
}
