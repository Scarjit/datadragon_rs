...
pub fn serialize(json: &str) -> Result<KennenJson,Error>{
...
pub struct KennenJson {
    #[serde(rename = "type")]
    pub kennen_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "KennenBringTheLight.png")]
    KennenBringTheLightPng,
    #[serde(rename = "KennenLightningRush.png")]
    KennenLightningRushPng,
    #[serde(rename = "Kennen_Passive.png")]
    KennenPassivePng,
    #[serde(rename = "Kennen.png")]
    KennenPng,
    #[serde(rename = "KennenShurikenHurlMissile1.png")]
    KennenShurikenHurlMissile1Png,
    #[serde(rename = "KennenShurikenStorm.png")]
    KennenShurikenStormPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "KennenARAM")]
    KennenAram,
    #[serde(rename = "KennenCS")]
    KennenCs,
    #[serde(rename = "KennenFIRSTBLOOD")]
    KennenFirstblood,
    #[serde(rename = "KennenKINGPORO")]
    KennenKingporo,
    #[serde(rename = "KennenSIEGE")]
    KennenSiege,
    #[serde(rename = "KennenSL")]
    KennenSl,
    #[serde(rename = "KennenSR")]
    KennenSr,
    #[serde(rename = "KennenTT")]
    KennenTt,
}
