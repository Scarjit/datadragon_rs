...
pub fn serialize(json: &str) -> Result<FiddlesticksJson,Error>{
...
pub struct FiddlesticksJson {
    #[serde(rename = "type")]
    pub fiddlesticks_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "Crowstorm.png")]
    CrowstormPng,
    #[serde(rename = "Drain.png")]
    DrainPng,
    #[serde(rename = "FiddleSticks_Passive.png")]
    FiddleSticksPassivePng,
    #[serde(rename = "FiddlesticksDarkWind.png")]
    FiddlesticksDarkWindPng,
    #[serde(rename = "Fiddlesticks.png")]
    FiddlesticksPng,
    #[serde(rename = "Terrify.png")]
    TerrifyPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "FiddleARAM")]
    FiddleAram,
    #[serde(rename = "FiddleFIRSTBLOOD")]
    FiddleFirstblood,
    #[serde(rename = "FiddleSL")]
    FiddleSl,
    #[serde(rename = "FiddleSR")]
    FiddleSr,
    #[serde(rename = "FiddleTT")]
    FiddleTt,
    #[serde(rename = "FiddlesticksCS")]
    FiddlesticksCs,
    #[serde(rename = "FiddlesticksKINGPORO")]
    FiddlesticksKingporo,
    #[serde(rename = "FiddlesticksSIEGE")]
    FiddlesticksSiege,
}
...
pub enum Effect {
    ...
    CostCostNl,
    #[serde(rename = "{{ damagepersecond }} -> {{ damagepersecondNL }}")]
    DamagepersecondDamagepersecondNl,
    ...
    EffectCostCostNl,
    #[serde(rename = "{{ damagepersecond }}->{{ damagepersecondNL }}")]
    EffectDamagepersecondDamagepersecondNl,
    #[serde(rename = "{{ e1 }}->{{ e1NL }}")]
    EffectE1E1Nl,
    #[serde(rename = "{{ e3 }}% -> {{ e3NL }}%")]
    EffectE3E3Nl,
