...
pub fn serialize(json: &str) -> Result<LeonaJson,Error>{
...
pub struct LeonaJson {
    #[serde(rename = "type")]
    pub leona_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "Leona.png")]
    LeonaPng,
    #[serde(rename = "LeonaShieldOfDaybreak.png")]
    LeonaShieldOfDaybreakPng,
    #[serde(rename = "LeonaSolarBarrier.png")]
    LeonaSolarBarrierPng,
    #[serde(rename = "LeonaSolarFlare.png")]
    LeonaSolarFlarePng,
    #[serde(rename = "LeonaSunlight.png")]
    LeonaSunlightPng,
    #[serde(rename = "LeonaZenithBlade.png")]
    LeonaZenithBladePng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "LeonaARAM")]
    LeonaAram,
    #[serde(rename = "LeonaCS")]
    LeonaCs,
    #[serde(rename = "LeonaFIRSTBLOOD")]
    LeonaFirstblood,
    #[serde(rename = "LeonaKINGPORO")]
    LeonaKingporo,
    #[serde(rename = "LeonaSIEGE")]
    LeonaSiege,
    #[serde(rename = "LeonaSL")]
    LeonaSl,
    #[serde(rename = "LeonaSR")]
    LeonaSr,
    #[serde(rename = "LeonaTT")]
    LeonaTt,
}
...
pub enum Effect {
    ...
    #[serde(rename = "{{ e4 }}->{{ e4NL }}")]
    EffectE4E4Nl,
    #[serde(rename = "{{ explosionbasedamage }}->{{ explosionbasedamageNL }}")]
    EffectExplosionbasedamageExplosionbasedamageNl,
    #[serde(rename = "{{ flatdamagereduction }}->{{ flatdamagereductionNL }}")]
    EffectFlatdamagereductionFlatdamagereductionNl,
    #[serde(rename = "{{ explosionbasedamage }} -> {{ explosionbasedamageNL }}")]
    ExplosionbasedamageExplosionbasedamageNl,
    #[serde(rename = "{{ flatdamagereduction }} -> {{ flatdamagereductionNL }}")]
    FlatdamagereductionFlatdamagereductionNl,
}
