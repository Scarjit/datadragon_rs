...
pub fn serialize(json: &str) -> Result<AatroxJson,Error>{
...
pub struct AatroxJson {
    #[serde(rename = "type")]
    pub aatrox_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "AatroxE.png")]
    AatroxEPng,
    #[serde(rename = "Aatrox_Passive.png")]
    AatroxPassivePng,
    #[serde(rename = "Aatrox.png")]
    AatroxPng,
    #[serde(rename = "AatroxQ.png")]
    AatroxQPng,
    #[serde(rename = "AatroxR.png")]
    AatroxRPng,
    #[serde(rename = "AatroxW.png")]
    AatroxWPng,
}
...
#[derive(Serialize, Deserialize)]
pub enum Title {
    #[serde(rename = "AatroxARAM")]
    AatroxAram,
    #[serde(rename = "AatroxCS")]
    AatroxCs,
    #[serde(rename = "AatroxFIRSTBLOOD")]
    AatroxFirstblood,
    #[serde(rename = "AatroxKINGPORO")]
    AatroxKingporo,
    #[serde(rename = "AatroxSIEGE")]
    AatroxSiege,
    #[serde(rename = "AatroxSL")]
    AatroxSl,
    #[serde(rename = "AatroxSR")]
    AatroxSr,
    #[serde(rename = "AatroxTT")]
    AatroxTt,
    Beginner,
}
...
pub enum CooldownBurn {
    ...
    The12010080,
    #[serde(rename = "14/12/10/8/6")]
    The14121086,
    #[serde(rename = "26/23/20/17/14")]
    The2623201714,
