...
pub struct FioraJson {
    #[serde(rename = "type")]
    pub fiora_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "FioraE.png")]
    FioraEPng,
    #[serde(rename = "Fiora_P.png")]
    FioraPPng,
    #[serde(rename = "Fiora.png")]
    FioraPng,
    #[serde(rename = "FioraQ.png")]
    FioraQPng,
    #[serde(rename = "FioraR.png")]
    FioraRPng,
    #[serde(rename = "FioraW.png")]
    FioraWPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "FioraARAM")]
    FioraAram,
    #[serde(rename = "FioraCS")]
    FioraCs,
    #[serde(rename = "FioraFIRSTBLOOD")]
    FioraFirstblood,
    #[serde(rename = "FioraKINGPORO")]
    FioraKingporo,
    #[serde(rename = "FioraSIEGE")]
    FioraSiege,
    #[serde(rename = "FioraSL")]
    FioraSl,
    #[serde(rename = "FioraSR")]
    FioraSr,
    #[serde(rename = "FioraTT")]
    FioraTt,
}
