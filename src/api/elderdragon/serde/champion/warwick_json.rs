...
pub fn serialize(json: &str) -> Result<WarwickJson,Error>{
...
pub struct WarwickJson {
    #[serde(rename = "type")]
    pub warwick_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "WarwickE.png")]
    WarwickEPng,
    #[serde(rename = "WarwickP.png")]
    WarwickPPng,
    #[serde(rename = "Warwick.png")]
    WarwickPng,
    #[serde(rename = "WarwickQ.png")]
    WarwickQPng,
    #[serde(rename = "WarwickR.png")]
    WarwickRPng,
    #[serde(rename = "WarwickW.png")]
    WarwickWPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "WarwickARAM")]
    WarwickAram,
    #[serde(rename = "WarwickCS")]
    WarwickCs,
    #[serde(rename = "WarwickFIRSTBLOOD")]
    WarwickFirstblood,
    #[serde(rename = "WarwickKINGPORO")]
    WarwickKingporo,
    #[serde(rename = "WarwickSIEGE")]
    WarwickSiege,
    #[serde(rename = "WarwickSL")]
    WarwickSl,
    #[serde(rename = "WarwickSR")]
    WarwickSr,
    #[serde(rename = "WarwickTT")]
    WarwickTt,
}
