...
pub fn serialize(json: &str) -> Result<TwitchJson,Error>{
...
pub struct TwitchJson {
    #[serde(rename = "type")]
    pub twitch_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "TwitchExpunge.png")]
    TwitchExpungePng,
    #[serde(rename = "TwitchFullAutomatic.png")]
    TwitchFullAutomaticPng,
    #[serde(rename = "TwitchHideInShadows.png")]
    TwitchHideInShadowsPng,
    #[serde(rename = "Twitch_Passive.png")]
    TwitchPassivePng,
    #[serde(rename = "Twitch.png")]
    TwitchPng,
    #[serde(rename = "TwitchVenomCask.png")]
    TwitchVenomCaskPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "TwitchARAM")]
    TwitchAram,
    #[serde(rename = "TwitchCS")]
    TwitchCs,
    #[serde(rename = "TwitchFIRSTBLOOD")]
    TwitchFirstblood,
    #[serde(rename = "TwitchKINGPORO")]
    TwitchKingporo,
    #[serde(rename = "TwitchSIEGE")]
    TwitchSiege,
    #[serde(rename = "TwitchSL")]
    TwitchSl,
    #[serde(rename = "TwitchSR")]
    TwitchSr,
    #[serde(rename = "TwitchTT")]
    TwitchTt,
}
