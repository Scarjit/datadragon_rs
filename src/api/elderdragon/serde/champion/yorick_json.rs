...
pub fn serialize(json: &str) -> Result<YorickJson,Error>{
...
pub struct YorickJson {
    #[serde(rename = "type")]
    pub yorick_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "YorickE.png")]
    YorickEPng,
    #[serde(rename = "Yorick_P.png")]
    YorickPPng,
    #[serde(rename = "Yorick.png")]
    YorickPng,
    #[serde(rename = "YorickQ.png")]
    YorickQPng,
    #[serde(rename = "YorickR.png")]
    YorickRPng,
    #[serde(rename = "YorickW.png")]
    YorickWPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "YorickARAM")]
    YorickAram,
    #[serde(rename = "YorickCS")]
    YorickCs,
    #[serde(rename = "YorickFIRSTBLOOD")]
    YorickFirstblood,
    #[serde(rename = "YorickKINGPORO")]
    YorickKingporo,
    #[serde(rename = "YorickSIEGE")]
    YorickSiege,
    #[serde(rename = "YorickSL")]
    YorickSl,
    #[serde(rename = "YorickSR")]
    YorickSr,
    #[serde(rename = "YorickTT")]
    YorickTt,
}
...
pub enum CooldownBurn {
    ...
    The12111098,
    #[serde(rename = "160/130/100")]
    The160130100,
    #[serde(rename = "20/18/16/14/12")]
    The2018161412,
    #[serde(rename = "7/6.25/5.5/4.75/4")]
    The7625554754,
}
