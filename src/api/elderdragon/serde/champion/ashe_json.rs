...
pub fn serialize(json: &str) -> Result<AsheJson,Error>{
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "Ashe_P.png")]
    AshePPng,
    #[serde(rename = "Ashe.png")]
    AshePng,
    #[serde(rename = "AsheQ.png")]
    AsheQPng,
    #[serde(rename = "AsheSpiritOfTheHawk.png")]
    AsheSpiritOfTheHawkPng,
    #[serde(rename = "EnchantedCrystalArrow.png")]
    EnchantedCrystalArrowPng,
    #[serde(rename = "Volley.png")]
    VolleyPng,
}
...
#[derive(Serialize, Deserialize)]
pub enum Title {
    #[serde(rename = "AsheARAM")]
    AsheAram,
    #[serde(rename = "AsheBT")]
    AsheBt,
    #[serde(rename = "AsheCS")]
    AsheCs,
    #[serde(rename = "AsheFIRSTBLOOD")]
    AsheFirstblood,
    #[serde(rename = "AsheKINGPORO")]
    AsheKingporo,
    #[serde(rename = "AshePRJ17")]
    AshePrj17,
    #[serde(rename = "AsheSIEGE")]
    AsheSiege,
    #[serde(rename = "AsheSL")]
    AsheSl,
    #[serde(rename = "AsheSR")]
