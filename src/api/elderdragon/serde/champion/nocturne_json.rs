...
pub fn serialize(json: &str) -> Result<NocturneJson,Error>{
...
pub struct NocturneJson {
    #[serde(rename = "type")]
    pub nocturne_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "NocturneDuskbringer.png")]
    NocturneDuskbringerPng,
    #[serde(rename = "NocturneParanoia.png")]
    NocturneParanoiaPng,
    #[serde(rename = "Nocturne.png")]
    NocturnePng,
    #[serde(rename = "NocturneShroudofDarkness.png")]
    NocturneShroudofDarknessPng,
    #[serde(rename = "Nocturne_UmbraBlades.png")]
    NocturneUmbraBladesPng,
    #[serde(rename = "NocturneUnspeakableHorror.png")]
    NocturneUnspeakableHorrorPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "NocturneARAM")]
    NocturneAram,
    #[serde(rename = "NocturneCS")]
    NocturneCs,
    #[serde(rename = "NocturneFIRSTBLOOD")]
    NocturneFirstblood,
    #[serde(rename = "NocturneKINGPORO")]
    NocturneKingporo,
    #[serde(rename = "NocturneSIEGE")]
    NocturneSiege,
    #[serde(rename = "NocturneSL")]
    NocturneSl,
    #[serde(rename = "NocturneSR")]
    NocturneSr,
    #[serde(rename = "NocturneTT")]
    NocturneTt,
}
...
pub enum Effect {
    ...
    #[serde(rename = "{{ castrange }} -> {{ castrangeNL }}")]
    CastrangeCastrangeNl,
