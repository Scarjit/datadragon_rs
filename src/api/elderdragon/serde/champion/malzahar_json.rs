...
pub fn serialize(json: &str) -> Result<MalzaharJson,Error>{
...
pub struct MalzaharJson {
    #[serde(rename = "type")]
    pub malzahar_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "MalzaharE.png")]
    MalzaharEPng,
    #[serde(rename = "Malzahar_Passive.png")]
    MalzaharPassivePng,
    #[serde(rename = "Malzahar.png")]
    MalzaharPng,
    #[serde(rename = "MalzaharQ.png")]
    MalzaharQPng,
    #[serde(rename = "MalzaharR.png")]
    MalzaharRPng,
    #[serde(rename = "MalzaharW.png")]
    MalzaharWPng,
}
...
#[derive(Serialize, Deserialize)]
pub enum Title {
    #[serde(rename = "MalzaharARAM")]
    MalzaharAram,
    #[serde(rename = "MalzaharCS")]
    MalzaharCs,
    #[serde(rename = "MalzaharKINGPORO")]
    MalzaharKingporo,
    #[serde(rename = "MalzaharSIEGE")]
    MalzaharSiege,
    #[serde(rename = "MalzaharSL")]
    MalzaharSl,
    #[serde(rename = "MalzaharSR")]
    MalzaharSr,
    #[serde(rename = "MalzaharTT")]
    MalzaharTt,
}
