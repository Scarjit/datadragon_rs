...
pub fn serialize(json: &str) -> Result<KassadinJson,Error>{
...
pub struct KassadinJson {
    #[serde(rename = "type")]
    pub kassadin_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "ForcePulse.png")]
    ForcePulsePng,
    #[serde(rename = "Kassadin_Passive.png")]
    KassadinPassivePng,
    #[serde(rename = "Kassadin.png")]
    KassadinPng,
    #[serde(rename = "NetherBlade.png")]
    NetherBladePng,
    #[serde(rename = "NullLance.png")]
    NullLancePng,
    #[serde(rename = "RiftWalk.png")]
    RiftWalkPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "KassadinARAM")]
    KassadinAram,
    #[serde(rename = "KassadinCS")]
    KassadinCs,
    #[serde(rename = "KassadinFIRSTBLOOD")]
    KassadinFirstblood,
    #[serde(rename = "KassadinKINGPORO")]
    KassadinKingporo,
    #[serde(rename = "KassadinSIEGE")]
    KassadinSiege,
    #[serde(rename = "KassadinSL")]
    KassadinSl,
    #[serde(rename = "KassadinSR")]
    KassadinSr,
    #[serde(rename = "KassadinTT")]
    KassadinTt,
}
