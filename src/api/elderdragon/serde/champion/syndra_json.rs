...
pub fn serialize(json: &str) -> Result<SyndraJson,Error>{
...
pub struct SyndraJson {
    #[serde(rename = "type")]
    pub syndra_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "SyndraE.png")]
    SyndraEPng,
    #[serde(rename = "SyndraPassive.png")]
    SyndraPassivePng,
    #[serde(rename = "Syndra.png")]
    SyndraPng,
    #[serde(rename = "SyndraQ.png")]
    SyndraQPng,
    #[serde(rename = "SyndraR.png")]
    SyndraRPng,
    #[serde(rename = "SyndraW.png")]
    SyndraWPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "SyndraARAM")]
    SyndraAram,
    #[serde(rename = "SyndraCS")]
    SyndraCs,
    #[serde(rename = "SyndraFIRSTBLOOD")]
    SyndraFirstblood,
    #[serde(rename = "SyndraKINGPORO")]
    SyndraKingporo,
    #[serde(rename = "SyndraSG")]
    SyndraSg,
    #[serde(rename = "SyndraSIEGE")]
    SyndraSiege,
    #[serde(rename = "SyndraSL")]
    SyndraSl,
    #[serde(rename = "SyndraSR")]
    SyndraSr,
    #[serde(rename = "SyndraTT")]
    SyndraTt,
}
...
pub enum Effect {
    ...
    CostCostNl,
    #[serde(rename = "{{ damagepersphere }} -> {{ damagepersphereNL }}")]
    DamagepersphereDamagepersphereNl,
    ...
    EffectCostCostNl,
    #[serde(rename = "{{ damagepersphere }}->{{ damagepersphereNL }}")]
    EffectDamagepersphereDamagepersphereNl,
    #[serde(rename = "{{ e1 }} % -> {{ e1NL }} %")]
    EffectE1E1Nl,
    #[serde(rename = "{{ e2 }}->{{ e2NL }}")]
    EffectE2E2Nl,
