...
pub fn serialize(json: &str) -> Result<SylasJson,Error>{
...
pub struct SylasJson {
    #[serde(rename = "type")]
    sylas_json_type: GroupEnum,
    format: Format,
    version: Version,
    data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "SylasE.png")]
    SylasEPng,
    #[serde(rename = "SylasP.png")]
    SylasPPng,
    #[serde(rename = "Sylas.png")]
    SylasPng,
    #[serde(rename = "SylasQ.png")]
    SylasQPng,
    #[serde(rename = "SylasR.png")]
    SylasRPng,
    #[serde(rename = "SylasW.png")]
    SylasWPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "SylasARAM")]
    SylasAram,
    #[serde(rename = "SylasCS")]
    SylasCs,
    #[serde(rename = "SylasFIRSTBLOOD")]
    SylasFirstblood,
    #[serde(rename = "SylasKINGPORO")]
    SylasKingporo,
    #[serde(rename = "SylasSG")]
    SylasSg,
    #[serde(rename = "SylasSIEGE")]
    SylasSiege,
    #[serde(rename = "SylasSR")]
    SylasSr,
    #[serde(rename = "SylasTT")]
    SylasTt,
}
