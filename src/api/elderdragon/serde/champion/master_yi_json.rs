...
pub fn serialize(json: &str) -> Result<MasterYiJson,Error>{
...
pub struct MasterYiJson {
    #[serde(rename = "type")]
    pub master_yi_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "AlphaStrike.png")]
    AlphaStrikePng,
    #[serde(rename = "Highlander.png")]
    HighlanderPng,
    #[serde(rename = "MasterYi_Passive1.png")]
    MasterYiPassive1Png,
    #[serde(rename = "MasterYi.png")]
    MasterYiPng,
    #[serde(rename = "Meditate.png")]
    MeditatePng,
    #[serde(rename = "WujuStyle.png")]
    WujuStylePng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "MasterYiARAM")]
    MasterYiAram,
    #[serde(rename = "MasterYiCS")]
    MasterYiCs,
    #[serde(rename = "MasterYiFIRSTBLOOD")]
    MasterYiFirstblood,
    #[serde(rename = "MasterYiKINGPORO")]
    MasterYiKingporo,
    #[serde(rename = "MasterYiNPE")]
    MasterYiNpe,
    #[serde(rename = "MasterYiSIEGE")]
    MasterYiSiege,
    #[serde(rename = "MasterYiSL")]
    MasterYiSl,
    #[serde(rename = "MasterYiSR")]
    MasterYiSr,
    #[serde(rename = "MasterYiTT")]
    MasterYiTt,
}
