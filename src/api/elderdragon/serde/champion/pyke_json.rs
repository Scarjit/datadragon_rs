...
pub fn serialize(json: &str) -> Result<PykeJson,Error>{
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "PykeE.png")]
    PykeEPng,
    #[serde(rename = "PykePassive.png")]
    PykePassivePng,
    #[serde(rename = "Pyke.png")]
    PykePng,
    #[serde(rename = "PykeQ.png")]
    PykeQPng,
    #[serde(rename = "PykeR.png")]
    PykeRPng,
    #[serde(rename = "PykeW.png")]
    PykeWPng,
}
...
#[derive(Serialize, Deserialize)]
pub enum Title {
    #[serde(rename = "PykeARAM")]
    PykeAram,
    #[serde(rename = "PykeCS")]
    PykeCs,
    #[serde(rename = "PykeFIRSTBLOOD")]
    PykeFirstblood,
    #[serde(rename = "PykeKINGPORO")]
    PykeKingporo,
    #[serde(rename = "PykeSIEGE")]
    PykeSiege,
    #[serde(rename = "PykeSL")]
    PykeSl,
    #[serde(rename = "PykeSR")]
