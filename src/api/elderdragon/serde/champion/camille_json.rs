...
pub fn serialize(json: &str) -> Result<CamilleJson,Error>{
...
pub struct CamilleJson {
    #[serde(rename = "type")]
    pub camille_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "CamilleE.png")]
    CamilleEPng,
    #[serde(rename = "Camille_Passive.png")]
    CamillePassivePng,
    #[serde(rename = "Camille.png")]
    CamillePng,
    #[serde(rename = "CamilleQ.png")]
    CamilleQPng,
    #[serde(rename = "CamilleR.png")]
    CamilleRPng,
    #[serde(rename = "CamilleW.png")]
    CamilleWPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "CamilleARAM")]
    CamilleAram,
    #[serde(rename = "CamilleCS")]
    CamilleCs,
    #[serde(rename = "CamilleFIRSTBLOOD")]
    CamilleFirstblood,
    #[serde(rename = "CamilleKINGPORO")]
    CamilleKingporo,
    #[serde(rename = "CamilleSIEGE")]
    CamilleSiege,
    #[serde(rename = "CamilleSL")]
    CamilleSl,
    #[serde(rename = "CamilleSR")]
    CamilleSr,
    #[serde(rename = "CamilleTT")]
    CamilleTt,
}

#[derive(Serialize, Deserialize)]
pub enum CooldownBurn {
    #[serde(rename = "140/115/90")]
    The14011590,
    #[serde(rename = "15/13.5/12/10.5/9")]
    The15135121059,
    #[serde(rename = "16/14.5/13/11.5/10")]
    The161451311510,
    #[serde(rename = "9/8.25/7.5/6.75/6")]
    The9825756756,
}
