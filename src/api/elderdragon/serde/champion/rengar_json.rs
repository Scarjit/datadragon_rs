...
pub fn serialize(json: &str) -> Result<RengarJson,Error>{
...
pub struct RengarJson {
    #[serde(rename = "type")]
    pub rengar_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "RengarE.png")]
    RengarEPng,
    #[serde(rename = "Rengar_P.png")]
    RengarPPng,
    #[serde(rename = "Rengar.png")]
    RengarPng,
    #[serde(rename = "RengarQ.png")]
    RengarQPng,
    #[serde(rename = "RengarR.png")]
    RengarRPng,
    #[serde(rename = "RengarW.png")]
    RengarWPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "RengarARAM")]
    RengarAram,
    #[serde(rename = "RengarCS")]
    RengarCs,
    #[serde(rename = "RengarFIRSTBLOOD")]
    RengarFirstblood,
    #[serde(rename = "RengarKINGPORO")]
    RengarKingporo,
    #[serde(rename = "RengarSIEGE")]
    RengarSiege,
    #[serde(rename = "RengarSL")]
    RengarSl,
    #[serde(rename = "RengarSR")]
    RengarSr,
    #[serde(rename = "RengarTT")]
    RengarTt,
}
