...
pub fn serialize(json: &str) -> Result<KarmaJson,Error>{
...
pub struct KarmaJson {
    #[serde(rename = "type")]
    pub karma_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "KarmaMantra.png")]
    KarmaMantraPng,
    #[serde(rename = "Karma_Passive.png")]
    KarmaPassivePng,
    #[serde(rename = "Karma.png")]
    KarmaPng,
    #[serde(rename = "KarmaQ.png")]
    KarmaQPng,
    #[serde(rename = "KarmaSolKimShield.png")]
    KarmaSolKimShieldPng,
    #[serde(rename = "KarmaSpiritBind.png")]
    KarmaSpiritBindPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "KarmaARAM")]
    KarmaAram,
    #[serde(rename = "KarmaCS")]
    KarmaCs,
    #[serde(rename = "KarmaFIRSTBLOOD")]
    KarmaFirstblood,
    #[serde(rename = "KarmaKINGPORO")]
    KarmaKingporo,
    #[serde(rename = "KarmaSIEGE")]
    KarmaSiege,
    #[serde(rename = "KarmaSL")]
    KarmaSl,
    #[serde(rename = "KarmaSR")]
    KarmaSr,
    #[serde(rename = "KarmaSRMid")]
    KarmaSrMid,
    #[serde(rename = "KarmaTT")]
    KarmaTt,
}
