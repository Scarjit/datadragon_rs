...
pub fn serialize(json: &str) -> Result<RenektonJson,Error>{
...
pub struct RenektonJson {
    #[serde(rename = "type")]
    pub renekton_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "RenektonCleave.png")]
    RenektonCleavePng,
    #[serde(rename = "Renekton_Passive.png")]
    RenektonPassivePng,
    #[serde(rename = "Renekton.png")]
    RenektonPng,
    #[serde(rename = "RenektonPreExecute.png")]
    RenektonPreExecutePng,
    #[serde(rename = "RenektonReignOfTheTyrant.png")]
    RenektonReignOfTheTyrantPng,
    #[serde(rename = "RenektonSliceAndDice.png")]
    RenektonSliceAndDicePng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "RenektonARAM")]
    RenektonAram,
    #[serde(rename = "RenektonCS")]
    RenektonCs,
    #[serde(rename = "RenektonFIRSTBLOOD")]
    RenektonFirstblood,
    #[serde(rename = "RenektonKINGPORO")]
    RenektonKingporo,
    #[serde(rename = "RenektonSIEGE")]
    RenektonSiege,
    #[serde(rename = "RenektonSL")]
    RenektonSl,
    #[serde(rename = "RenektonSR")]
    RenektonSr,
    #[serde(rename = "RenektonTT")]
    RenektonTt,
}
