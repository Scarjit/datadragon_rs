...
pub fn serialize(json: &str) -> Result<OlafJson,Error>{
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "OlafAxeThrowCast.png")]
    OlafAxeThrowCastPng,
    #[serde(rename = "OlafFrenziedStrikes.png")]
    OlafFrenziedStrikesPng,
    #[serde(rename = "Olaf_Passive.png")]
    OlafPassivePng,
    #[serde(rename = "Olaf.png")]
    OlafPng,
    #[serde(rename = "OlafRagnarok.png")]
    OlafRagnarokPng,
    #[serde(rename = "OlafRecklessStrike.png")]
    OlafRecklessStrikePng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "OlafARAM")]
    OlafAram,
    #[serde(rename = "OlafCS")]
    OlafCs,
    #[serde(rename = "OlafFIRSTBLOOD")]
    OlafFirstblood,
    #[serde(rename = "OlafKINGPORO")]
    OlafKingporo,
    #[serde(rename = "OlafSIEGE")]
    OlafSiege,
    #[serde(rename = "OlafSL")]
    OlafSl,
    #[serde(rename = "OlafSR")]
