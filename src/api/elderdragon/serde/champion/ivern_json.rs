...
pub fn serialize(json: &str) -> Result<IvernJson,Error>{
...
pub struct IvernJson {
    #[serde(rename = "type")]
    pub ivern_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "IvernE.png")]
    IvernEPng,
    #[serde(rename = "IvernP.png")]
    IvernPPng,
    #[serde(rename = "Ivern.png")]
    IvernPng,
    #[serde(rename = "IvernQ.png")]
    IvernQPng,
    #[serde(rename = "IvernR.png")]
    IvernRPng,
    #[serde(rename = "IvernW.png")]
    IvernWPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "IvernARAM")]
    IvernAram,
    #[serde(rename = "IvernCS")]
    IvernCs,
    #[serde(rename = "IvernFIRSTBLOOD")]
    IvernFirstblood,
    #[serde(rename = "IvernKINGPORO")]
    IvernKingporo,
    #[serde(rename = "IvernSIEGE")]
    IvernSiege,
    #[serde(rename = "IvernSL")]
    IvernSl,
    #[serde(rename = "IvernSR")]
    IvernSr,
    #[serde(rename = "IvernTT")]
    IvernTt,
}
