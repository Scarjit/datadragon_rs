...
pub fn serialize(json: &str) -> Result<XinZhaoJson,Error>{
...
pub struct XinZhaoJson {
    #[serde(rename = "type")]
    pub xin_zhao_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "XinZhaoE.png")]
    XinZhaoEPng,
    #[serde(rename = "XinZhaoP.png")]
    XinZhaoPPng,
    #[serde(rename = "XinZhao.png")]
    XinZhaoPng,
    #[serde(rename = "XinZhaoQ.png")]
    XinZhaoQPng,
    #[serde(rename = "XinZhaoR.png")]
    XinZhaoRPng,
    #[serde(rename = "XinZhaoW.png")]
    XinZhaoWPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "XinZhaoARAM")]
    XinZhaoAram,
    #[serde(rename = "XinZhaoCS")]
    XinZhaoCs,
    #[serde(rename = "XinZhaoFIRSTBLOOD")]
    XinZhaoFirstblood,
    #[serde(rename = "XinZhaoKINGPORO")]
    XinZhaoKingporo,
    #[serde(rename = "XinZhaoSIEGE")]
    XinZhaoSiege,
    #[serde(rename = "XinZhaoSL")]
    XinZhaoSl,
    #[serde(rename = "XinZhaoSR")]
    XinZhaoSr,
    #[serde(rename = "XinZhaoTT")]
    XinZhaoTt,
}
