...
pub fn serialize(json: &str) -> Result<SivirJson,Error>{
...
pub struct SivirJson {
    #[serde(rename = "type")]
    sivir_json_type: GroupEnum,
    format: Format,
    version: Version,
    data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "SivirE.png")]
    SivirEPng,
    #[serde(rename = "Sivir_Passive.png")]
    SivirPassivePng,
    #[serde(rename = "Sivir.png")]
    SivirPng,
    #[serde(rename = "SivirQ.png")]
    SivirQPng,
    #[serde(rename = "SivirR.png")]
    SivirRPng,
    #[serde(rename = "SivirW.png")]
    SivirWPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "SivirARAM")]
    SivirAram,
    #[serde(rename = "SivirCS")]
    SivirCs,
    #[serde(rename = "SivirFIRSTBLOOD")]
    SivirFirstblood,
    #[serde(rename = "SivirKINGPORO")]
    SivirKingporo,
    #[serde(rename = "SivirPRJ17")]
    SivirPrj17,
    #[serde(rename = "SivirSIEGE")]
    SivirSiege,
    #[serde(rename = "SivirSL")]
    SivirSl,
    #[serde(rename = "SivirSR")]
    SivirSr,
    #[serde(rename = "SivirTT")]
    SivirTt,
}
