...
pub fn serialize(json: &str) -> Result<VeigarJson,Error>{
...
pub struct VeigarJson {
    #[serde(rename = "type")]
    pub veigar_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "VeigarBalefulStrike.png")]
    VeigarBalefulStrikePng,
    #[serde(rename = "VeigarDarkMatter.png")]
    VeigarDarkMatterPng,
    #[serde(rename = "Veigar_Entropy.png")]
    VeigarEntropyPng,
    #[serde(rename = "VeigarEventHorizon.png")]
    VeigarEventHorizonPng,
    #[serde(rename = "Veigar.png")]
    VeigarPng,
    #[serde(rename = "VeigarR.png")]
    VeigarRPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "VeigarARAM")]
    VeigarAram,
    #[serde(rename = "VeigarCS")]
    VeigarCs,
    #[serde(rename = "VeigarFIRSTBLOOD")]
    VeigarFirstblood,
    #[serde(rename = "VeigarKINGPORO")]
    VeigarKingporo,
    #[serde(rename = "VeigarSIEGE")]
    VeigarSiege,
    #[serde(rename = "VeigarSL")]
    VeigarSl,
    #[serde(rename = "VeigarSR")]
    VeigarSr,
    #[serde(rename = "VeigarTT")]
    VeigarTt,
}
