...
pub fn serialize(json: &str) -> Result<NidaleeJson,Error>{
...
pub struct NidaleeJson {
    #[serde(rename = "type")]
    pub nidalee_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "AspectOfTheCougar.png")]
    AspectOfTheCougarPng,
    #[serde(rename = "Bushwhack.png")]
    BushwhackPng,
    #[serde(rename = "JavelinToss.png")]
    JavelinTossPng,
    #[serde(rename = "Nidalee_Passive.png")]
    NidaleePassivePng,
    #[serde(rename = "Nidalee.png")]
    NidaleePng,
    #[serde(rename = "PrimalSurge.png")]
    PrimalSurgePng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "NidaleeARAM")]
    NidaleeAram,
    #[serde(rename = "NidaleeCS")]
    NidaleeCs,
    #[serde(rename = "NidaleeFIRSTBLOOD")]
    NidaleeFirstblood,
    #[serde(rename = "NidaleeKINGPORO")]
    NidaleeKingporo,
    #[serde(rename = "NidaleeSIEGE")]
    NidaleeSiege,
    #[serde(rename = "NidaleeSL")]
    NidaleeSl,
    #[serde(rename = "NidaleeSR")]
    NidaleeSr,
    #[serde(rename = "NidaleeTT")]
    NidaleeTt,
}
