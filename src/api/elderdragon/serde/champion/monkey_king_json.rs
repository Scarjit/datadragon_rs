...
pub fn serialize(json: &str) -> Result<MonkeyKingJson,Error>{
...
pub struct MonkeyKingJson {
    #[serde(rename = "type")]
    pub monkey_king_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "MonkeyKingDecoy.png")]
    MonkeyKingDecoyPng,
    #[serde(rename = "MonkeyKingDoubleAttack.png")]
    MonkeyKingDoubleAttackPng,
    #[serde(rename = "MonkeyKingNimbus.png")]
    MonkeyKingNimbusPng,
    #[serde(rename = "MonkeyKing.png")]
    MonkeyKingPng,
    #[serde(rename = "MonkeyKingSpinToWin.png")]
    MonkeyKingSpinToWinPng,
    #[serde(rename = "MonkeyKingStoneSkin.png")]
    MonkeyKingStoneSkinPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "MonkeyKingCS")]
    MonkeyKingCs,
    #[serde(rename = "MonkeyKingKINGPORO")]
    MonkeyKingKingporo,
    #[serde(rename = "MonkeyKingSIEGE")]
    MonkeyKingSiege,
    #[serde(rename = "WukongARAM")]
    WukongAram,
    #[serde(rename = "WukongFIRSTBLOOD")]
    WukongFirstblood,
    #[serde(rename = "WukongSL")]
    WukongSl,
    #[serde(rename = "WukongSR")]
    WukongSr,
    #[serde(rename = "WukongTT")]
    WukongTt,
}
