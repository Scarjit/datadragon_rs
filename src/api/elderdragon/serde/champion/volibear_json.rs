...
pub fn serialize(json: &str) -> Result<VolibearJson,Error>{
...
pub struct VolibearJson {
    #[serde(rename = "type")]
    pub volibear_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "VolibearE.png")]
    VolibearEPng,
    #[serde(rename = "VolibearPassive.png")]
    VolibearPassivePng,
    #[serde(rename = "Volibear.png")]
    VolibearPng,
    #[serde(rename = "VolibearQ.png")]
    VolibearQPng,
    #[serde(rename = "VolibearR.png")]
    VolibearRPng,
    #[serde(rename = "VolibearW.png")]
    VolibearWPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "VolibearARAM")]
    VolibearAram,
    #[serde(rename = "VolibearCS")]
    VolibearCs,
    #[serde(rename = "VolibearFIRSTBLOOD")]
    VolibearFirstblood,
    #[serde(rename = "VolibearKINGPORO")]
    VolibearKingporo,
    #[serde(rename = "VolibearSIEGE")]
    VolibearSiege,
    #[serde(rename = "VolibearSL")]
    VolibearSl,
    #[serde(rename = "VolibearSR")]
    VolibearSr,
    #[serde(rename = "VolibearTT")]
    VolibearTt,
}
