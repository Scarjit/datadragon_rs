...
pub fn serialize(json: &str) -> Result<GalioJson,Error>{
...
pub struct GalioJson {
    #[serde(rename = "type")]
    pub galio_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "GalioE.png")]
    GalioEPng,
    #[serde(rename = "Galio_Passive.png")]
    GalioPassivePng,
    #[serde(rename = "Galio.png")]
    GalioPng,
    #[serde(rename = "GalioQ.png")]
    GalioQPng,
    #[serde(rename = "GalioR.png")]
    GalioRPng,
    #[serde(rename = "GalioW.png")]
    GalioWPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "GalioARAM")]
    GalioAram,
    #[serde(rename = "GalioCS")]
    GalioCs,
    #[serde(rename = "GalioFIRSTBLOOD")]
    GalioFirstblood,
    #[serde(rename = "GalioKINGPORO")]
    GalioKingporo,
    #[serde(rename = "GalioSIEGE")]
    GalioSiege,
    #[serde(rename = "GalioSL")]
    GalioSl,
    #[serde(rename = "GalioSR")]
    GalioSr,
    #[serde(rename = "GalioTT")]
    GalioTt,
}
