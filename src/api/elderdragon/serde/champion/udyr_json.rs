...
pub fn serialize(json: &str) -> Result<UdyrJson,Error>{
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "UdyrBearStance.png")]
    UdyrBearStancePng,
    #[serde(rename = "Udyr_MonkeysAgility.png")]
    UdyrMonkeysAgilityPng,
    #[serde(rename = "UdyrPhoenixStance.png")]
    UdyrPhoenixStancePng,
    #[serde(rename = "Udyr.png")]
    UdyrPng,
    #[serde(rename = "UdyrTigerStance.png")]
    UdyrTigerStancePng,
    #[serde(rename = "UdyrTurtleStance.png")]
    UdyrTurtleStancePng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "UdyrARAM")]
    UdyrAram,
    #[serde(rename = "UdyrCS")]
    UdyrCs,
    #[serde(rename = "UdyrFIRSTBLOOD")]
    UdyrFirstblood,
    #[serde(rename = "UdyrKINGPORO")]
    UdyrKingporo,
    #[serde(rename = "UdyrSIEGE")]
    UdyrSiege,
    #[serde(rename = "UdyrSL")]
    UdyrSl,
    #[serde(rename = "UdyrSR")]
