...
pub fn serialize(json: &str) -> Result<EkkoJson,Error>{
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "EkkoE.png")]
    EkkoEPng,
    #[serde(rename = "Ekko_P.png")]
    EkkoPPng,
    #[serde(rename = "Ekko.png")]
    EkkoPng,
    #[serde(rename = "EkkoQ.png")]
    EkkoQPng,
    #[serde(rename = "EkkoR.png")]
    EkkoRPng,
    #[serde(rename = "EkkoW.png")]
    EkkoWPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "EkkoARAM")]
    EkkoAram,
    #[serde(rename = "EkkoCS")]
    EkkoCs,
    #[serde(rename = "EkkoFIRSTBLOOD")]
    EkkoFirstblood,
    #[serde(rename = "EkkoKINGPORO")]
    EkkoKingporo,
    #[serde(rename = "EkkoSIEGE")]
    EkkoSiege,
    #[serde(rename = "EkkoSL")]
    EkkoSl,
    #[serde(rename = "EkkoSR")]
