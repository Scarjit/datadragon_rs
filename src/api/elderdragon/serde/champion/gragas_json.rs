...
pub fn serialize(json: &str) -> Result<GragasJson,Error>{
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "GragasE.png")]
    GragasEPng,
    #[serde(rename = "GragasPassiveHeal.png")]
    GragasPassiveHealPng,
    #[serde(rename = "Gragas.png")]
    GragasPng,
    #[serde(rename = "GragasQ.png")]
    GragasQPng,
    #[serde(rename = "GragasR.png")]
    GragasRPng,
    #[serde(rename = "GragasW.png")]
    GragasWPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "GragasARAM")]
    GragasAram,
    #[serde(rename = "GragasCS")]
    GragasCs,
    #[serde(rename = "GragasFIRSTBLOOD")]
    GragasFirstblood,
    #[serde(rename = "GragasKINGPORO")]
    GragasKingporo,
    #[serde(rename = "GragasSIEGE")]
    GragasSiege,
    #[serde(rename = "GragasSL")]
    GragasSl,
    #[serde(rename = "GragasSR")]
    GragasSr,
    #[serde(rename = "GragasTT")]
    GragasTt,
}
