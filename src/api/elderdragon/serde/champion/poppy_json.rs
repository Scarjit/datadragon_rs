...
pub fn serialize(json: &str) -> Result<PoppyJson,Error>{
...
pub struct PoppyJson {
    #[serde(rename = "type")]
    pub poppy_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "PoppyE.png")]
    PoppyEPng,
    #[serde(rename = "Poppy_Passive.png")]
    PoppyPassivePng,
    #[serde(rename = "Poppy.png")]
    PoppyPng,
    #[serde(rename = "PoppyQ.png")]
    PoppyQPng,
    #[serde(rename = "PoppyR.png")]
    PoppyRPng,
    #[serde(rename = "PoppyW.png")]
    PoppyWPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "PoppyARAM")]
    PoppyAram,
    #[serde(rename = "PoppyCS")]
    PoppyCs,
    #[serde(rename = "PoppyFIRSTBLOOD")]
    PoppyFirstblood,
    #[serde(rename = "PoppyKINGPORO")]
    PoppyKingporo,
    #[serde(rename = "PoppySG")]
    PoppySg,
    #[serde(rename = "PoppySIEGE")]
    PoppySiege,
    #[serde(rename = "PoppySL")]
    PoppySl,
    #[serde(rename = "PoppySR")]
    PoppySr,
    #[serde(rename = "PoppyTT")]
    PoppyTt,
}
