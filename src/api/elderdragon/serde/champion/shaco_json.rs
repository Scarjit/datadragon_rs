...
pub fn serialize(json: &str) -> Result<ShacoJson,Error>{
...
pub struct ShacoJson {
    #[serde(rename = "type")]
    pub shaco_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "Deceive.png")]
    DeceivePng,
    #[serde(rename = "HallucinateFull.png")]
    HallucinateFullPng,
    #[serde(rename = "JackInTheBox.png")]
    JackInTheBoxPng,
    #[serde(rename = "Jester_CarefulStrikes.png")]
    JesterCarefulStrikesPng,
    #[serde(rename = "Shaco.png")]
    ShacoPng,
    #[serde(rename = "TwoShivPoison.png")]
    TwoShivPoisonPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "ShacoARAM")]
    ShacoAram,
    #[serde(rename = "ShacoCS")]
    ShacoCs,
    #[serde(rename = "ShacoFIRSTBLOOD")]
    ShacoFirstblood,
    #[serde(rename = "ShacoKINGPORO")]
    ShacoKingporo,
    #[serde(rename = "ShacoSIEGE")]
    ShacoSiege,
    #[serde(rename = "ShacoSL")]
    ShacoSl,
    #[serde(rename = "ShacoSR")]
    ShacoSr,
    #[serde(rename = "ShacoTT")]
    ShacoTt,
}
