...
pub fn serialize(json: &str) -> Result<NasusJson,Error>{
...
pub struct NasusJson {
    #[serde(rename = "type")]
    pub nasus_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "NasusE.png")]
    NasusEPng,
    #[serde(rename = "Nasus_Passive.png")]
    NasusPassivePng,
    #[serde(rename = "Nasus.png")]
    NasusPng,
    #[serde(rename = "NasusQ.png")]
    NasusQPng,
    #[serde(rename = "NasusR.png")]
    NasusRPng,
    #[serde(rename = "NasusW.png")]
    NasusWPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "NasusARAM")]
    NasusAram,
    #[serde(rename = "NasusCS")]
    NasusCs,
    #[serde(rename = "NasusFIRSTBLOOD")]
    NasusFirstblood,
    #[serde(rename = "NasusKINGPORO")]
    NasusKingporo,
    #[serde(rename = "NasusSIEGE")]
    NasusSiege,
    #[serde(rename = "NasusSL")]
    NasusSl,
    #[serde(rename = "NasusSR")]
    NasusSr,
    #[serde(rename = "NasusTT")]
    NasusTt,
}
