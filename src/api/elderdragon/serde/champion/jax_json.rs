...
pub fn serialize(json: &str) -> Result<JaxJson,Error>{
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "Armsmaster_MasterOfArms.png")]
    ArmsmasterMasterOfArmsPng,
    #[serde(rename = "JaxCounterStrike.png")]
    JaxCounterStrikePng,
    #[serde(rename = "JaxEmpowerTwo.png")]
    JaxEmpowerTwoPng,
    #[serde(rename = "JaxLeapStrike.png")]
    JaxLeapStrikePng,
    #[serde(rename = "Jax.png")]
    JaxPng,
    #[serde(rename = "JaxRelentlessAssault.png")]
    JaxRelentlessAssaultPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "JaxARAM")]
    JaxAram,
    #[serde(rename = "JaxCS")]
    JaxCs,
    #[serde(rename = "JaxFIRSTBLOOD")]
    JaxFirstblood,
    #[serde(rename = "JaxKINGPORO")]
    JaxKingporo,
    #[serde(rename = "JaxSIEGE")]
    JaxSiege,
    #[serde(rename = "JaxSL")]
    JaxSl,
    #[serde(rename = "JaxSR")]
...
#[derive(Serialize, Deserialize)]
pub enum Effect {
    #[serde(rename = "{{ activebaseresists }} -> {{ activebaseresistsNL }}")]
    ActivebaseresistsActivebaseresistsNl,
    ...
    E1E1Nl,
    #[serde(rename = "{{ activebaseresists }}->{{ activebaseresistsNL }}")]
    EffectActivebaseresistsActivebaseresistsNl,
    #[serde(rename = "{{ cooldown }}->{{ cooldownNL }}")]
    ...
    #[serde(rename = "{{ e1 }}->{{ e1NL }}")]
    EffectE1E1Nl,
    #[serde(rename = "{{ passivedamage }}->{{ passivedamageNL }}")]
    EffectPassivedamagePassivedamageNl,
    #[serde(rename = "{{ passivedamage }} -> {{ passivedamageNL }}")]
    PassivedamagePassivedamageNl,
}
