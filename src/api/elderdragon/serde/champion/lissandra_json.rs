...
pub fn serialize(json: &str) -> Result<LissandraJson,Error>{
...
pub struct LissandraJson {
    #[serde(rename = "type")]
    pub lissandra_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "LissandraE.png")]
    LissandraEPng,
    #[serde(rename = "Lissandra_Passive.png")]
    LissandraPassivePng,
    #[serde(rename = "Lissandra.png")]
    LissandraPng,
    #[serde(rename = "LissandraQ.png")]
    LissandraQPng,
    #[serde(rename = "LissandraR.png")]
    LissandraRPng,
    #[serde(rename = "LissandraW.png")]
    LissandraWPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "LissandraARAM")]
    LissandraAram,
    #[serde(rename = "LissandraCS")]
    LissandraCs,
    #[serde(rename = "LissandraFIRSTBLOOD")]
    LissandraFirstblood,
    #[serde(rename = "LissandraKINGPORO")]
    LissandraKingporo,
    #[serde(rename = "LissandraSIEGE")]
    LissandraSiege,
    #[serde(rename = "LissandraSL")]
    LissandraSl,
    #[serde(rename = "LissandraSR")]
    LissandraSr,
    #[serde(rename = "LissandraTT")]
    LissandraTt,
}

#[derive(Serialize, Deserialize)]
pub enum CooldownBurn {
    #[serde(rename = "10/8.5/7/5.5/4")]
    The10857554,
