...
pub fn serialize(json: &str) -> Result<IreliaJson,Error>{
...
pub struct IreliaJson {
    #[serde(rename = "type")]
    pub irelia_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "IreliaE.png")]
    IreliaEPng,
    #[serde(rename = "Irelia_Passive.png")]
    IreliaPassivePng,
    #[serde(rename = "Irelia.png")]
    IreliaPng,
    #[serde(rename = "IreliaQ.png")]
    IreliaQPng,
    #[serde(rename = "IreliaR.png")]
    IreliaRPng,
    #[serde(rename = "IreliaW.png")]
    IreliaWPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "IreliaARAM")]
    IreliaAram,
    #[serde(rename = "IreliaCS")]
    IreliaCs,
    #[serde(rename = "IreliaFIRSTBLOOD")]
    IreliaFirstblood,
    #[serde(rename = "IreliaKINGPORO")]
    IreliaKingporo,
    #[serde(rename = "IreliaSIEGE")]
    IreliaSiege,
    #[serde(rename = "IreliaSL")]
    IreliaSl,
    #[serde(rename = "IreliaSR")]
    IreliaSr,
    #[serde(rename = "IreliaTT")]
    IreliaTt,
}
...
pub enum CooldownBurn {
    ...
    The140120100,
    #[serde(rename = "18/16.5/15/13.5/12")]
    The181651513512,
