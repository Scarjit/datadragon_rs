...
pub fn serialize(json: &str) -> Result<LeblancJson,Error>{
...
pub struct LeblancJson {
    #[serde(rename = "type")]
    pub leblanc_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "LeBlancP.png")]
    LeBlancPPng,
    #[serde(rename = "LeblancE.png")]
    LeblancEPng,
    #[serde(rename = "Leblanc.png")]
    LeblancPng,
    #[serde(rename = "LeblancQ.png")]
    LeblancQPng,
    #[serde(rename = "LeblancR.png")]
    LeblancRPng,
    #[serde(rename = "LeblancW.png")]
    LeblancWPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "LeBlancSL")]
    LeBlancSl,
    #[serde(rename = "LeblancARAM")]
    LeblancAram,
    #[serde(rename = "LeblancCS")]
    LeblancCs,
    #[serde(rename = "LeblancFIRSTBLOOD")]
    LeblancFirstblood,
    #[serde(rename = "LeblancKINGPORO")]
    LeblancKingporo,
    #[serde(rename = "LeblancSIEGE")]
    LeblancSiege,
    #[serde(rename = "LeblancSR")]
    LeblancSr,
    #[serde(rename = "LeblancTT")]
    LeblancTt,
}
...
pub enum Effect {
    ...
    #[serde(rename = "{{ e2 }}->{{ e2NL }}")]
    EffectE2E2Nl,
    #[serde(rename = "{{ rq1base }}->{{ rq1baseNL }}")]
    EffectRq1BaseRq1BaseNl,
    #[serde(rename = "{{ rq2base }}->{{ rq2baseNL }}")]
    EffectRq2BaseRq2BaseNl,
    #[serde(rename = "{{ rwbase }}->{{ rwbaseNL }}")]
    EffectRwbaseRwbaseNl,
    #[serde(rename = "{{ rq1base }} -> {{ rq1baseNL }}")]
    Rq1BaseRq1BaseNl,
    #[serde(rename = "{{ rq2base }} -> {{ rq2baseNL }}")]
    Rq2BaseRq2BaseNl,
