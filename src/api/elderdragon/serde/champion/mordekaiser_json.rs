...
pub fn serialize(json: &str) -> Result<MordekaiserJson,Error>{
...
pub struct MordekaiserJson {
    #[serde(rename = "type")]
    pub mordekaiser_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "MordekaiserE.png")]
    MordekaiserEPng,
    #[serde(rename = "MordekaiserPassive.MordeVGU.png")]
    MordekaiserPassiveMordeVguPng,
    #[serde(rename = "Mordekaiser.png")]
    MordekaiserPng,
    #[serde(rename = "MordekaiserQ.png")]
    MordekaiserQPng,
    #[serde(rename = "MordekaiserR.png")]
    MordekaiserRPng,
    #[serde(rename = "MordekaiserW.png")]
    MordekaiserWPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "MordekaiserARAM")]
    MordekaiserAram,
    #[serde(rename = "MordekaiserCS")]
    MordekaiserCs,
    #[serde(rename = "MordekaiserFIRSTBLOOD")]
    MordekaiserFirstblood,
    #[serde(rename = "MordekaiserKINGPORO")]
    MordekaiserKingporo,
    #[serde(rename = "MordekaiserSIEGE")]
    MordekaiserSiege,
    #[serde(rename = "MordekaiserSL")]
    MordekaiserSl,
    #[serde(rename = "MordekaiserSR")]
    MordekaiserSr,
    #[serde(rename = "MordekaiserTT")]
    MordekaiserTt,
}
...
pub enum CooldownBurn {
    ...
    The1413121110,
    #[serde(rename = "24/21/18/15/12")]
    The2421181512,
    #[serde(rename = "9/7.75/6.5/5.25/4")]
    The9775655254,
}
