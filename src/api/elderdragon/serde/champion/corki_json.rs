...
pub fn serialize(json: &str) -> Result<CorkiJson,Error>{
...
pub struct CorkiJson {
    #[serde(rename = "type")]
    pub corki_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "CarpetBomb.png")]
    CarpetBombPng,
    #[serde(rename = "Corki.png")]
    CorkiPng,
    #[serde(rename = "Corki_RapidReload.png")]
    CorkiRapidReloadPng,
    #[serde(rename = "GGun.png")]
    GGunPng,
    #[serde(rename = "MissileBarrage.png")]
    MissileBarragePng,
    #[serde(rename = "PhosphorusBomb.png")]
    PhosphorusBombPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "CorkiARAM")]
    CorkiAram,
    #[serde(rename = "CorkiCS")]
    CorkiCs,
    #[serde(rename = "CorkiFIRSTBLOOD")]
    CorkiFirstblood,
    #[serde(rename = "CorkiKINGPORO")]
    CorkiKingporo,
    #[serde(rename = "CorkiPRJ17")]
    CorkiPrj17,
    #[serde(rename = "CorkiSIEGE")]
    CorkiSiege,
    #[serde(rename = "CorkiSL")]
    CorkiSl,
    #[serde(rename = "CorkiSR")]
    CorkiSr,
    #[serde(rename = "CorkiTT")]
    CorkiTt,
}
