...
pub fn serialize(json: &str) -> Result<TaricJson,Error>{
...
pub struct TaricJson {
    #[serde(rename = "type")]
    pub taric_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "TaricE.png")]
    TaricEPng,
    #[serde(rename = "Taric_Passive.png")]
    TaricPassivePng,
    #[serde(rename = "Taric.png")]
    TaricPng,
    #[serde(rename = "TaricQ.png")]
    TaricQPng,
    #[serde(rename = "TaricR.png")]
    TaricRPng,
    #[serde(rename = "TaricW.png")]
    TaricWPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "TaricARAM")]
    TaricAram,
    #[serde(rename = "TaricCS")]
    TaricCs,
    #[serde(rename = "TaricFIRSTBLOOD")]
    TaricFirstblood,
    #[serde(rename = "TaricKINGPORO")]
    TaricKingporo,
    #[serde(rename = "TaricSIEGE")]
    TaricSiege,
    #[serde(rename = "TaricSL")]
    TaricSl,
    #[serde(rename = "TaricSR")]
    TaricSr,
    #[serde(rename = "TaricTT")]
    TaricTt,
}
