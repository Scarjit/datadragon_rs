...
pub fn serialize(json: &str) -> Result<BardJson,Error>{
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "BardE.png")]
    BardEPng,
    #[serde(rename = "Bard_Passive.png")]
    BardPassivePng,
    #[serde(rename = "Bard.png")]
    BardPng,
    #[serde(rename = "BardQ.png")]
    BardQPng,
    #[serde(rename = "BardR.png")]
    BardRPng,
    #[serde(rename = "BardW.png")]
    BardWPng,
}
...
#[derive(Serialize, Deserialize)]
pub enum Title {
    #[serde(rename = "BardARAM")]
    BardAram,
    #[serde(rename = "BardCS")]
    BardCs,
    #[serde(rename = "BardFIRSTBLOOD")]
    BardFirstblood,
    #[serde(rename = "BardKINGPORO")]
    BardKingporo,
    #[serde(rename = "BardSIEGE")]
    BardSiege,
    #[serde(rename = "BardSL")]
    BardSl,
    #[serde(rename = "BardSR")]
