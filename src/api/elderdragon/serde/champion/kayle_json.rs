...
pub fn serialize(json: &str) -> Result<KayleJson,Error>{
...
pub struct KayleJson {
    #[serde(rename = "type")]
    pub kayle_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "KayleE.png")]
    KayleEPng,
    #[serde(rename = "Kayle_P.png")]
    KaylePPng,
    #[serde(rename = "Kayle.png")]
    KaylePng,
    #[serde(rename = "KayleQ.png")]
    KayleQPng,
    #[serde(rename = "KayleR.png")]
    KayleRPng,
    #[serde(rename = "KayleW.png")]
    KayleWPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "KayleARAM")]
    KayleAram,
    #[serde(rename = "KayleCS")]
    KayleCs,
    #[serde(rename = "KayleFIRSTBLOOD")]
    KayleFirstblood,
    #[serde(rename = "KayleKINGPORO")]
    KayleKingporo,
    #[serde(rename = "KayleSIEGE")]
    KayleSiege,
    #[serde(rename = "KayleSL")]
    KayleSl,
    #[serde(rename = "KayleSR")]
    KayleSr,
    #[serde(rename = "KayleTT")]
    KayleTt,
}

#[derive(Serialize, Deserialize)]
pub enum CostBurn {
    #[serde(rename = "100/50/0")]
    The100500,
    #[serde(rename = "50/55/60/65/70")]
    The5055606570,
    #[serde(rename = "70/75/80/85/90")]
    The7075808590,
    #[serde(rename = "70/80/90/100/110")]
    The708090100110,
}
