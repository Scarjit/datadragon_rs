...
pub fn serialize(json: &str) -> Result<SwainJson,Error>{
...
pub struct SwainJson {
    #[serde(rename = "type")]
    pub swain_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "SwainE.png")]
    SwainEPng,
    #[serde(rename = "Swain_P.png")]
    SwainPPng,
    #[serde(rename = "Swain.png")]
    SwainPng,
    #[serde(rename = "SwainQ.png")]
    SwainQPng,
    #[serde(rename = "SwainR.png")]
    SwainRPng,
    #[serde(rename = "SwainW.png")]
    SwainWPng,
}
