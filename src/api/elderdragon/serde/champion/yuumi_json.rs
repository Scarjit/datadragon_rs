...
pub fn serialize(json: &str) -> Result<YuumiJson,Error>{
...
pub struct YuumiJson {
    #[serde(rename = "type")]
    pub yuumi_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "YuumiE.png")]
    YuumiEPng,
    #[serde(rename = "YuumiP.png")]
    YuumiPPng,
    #[serde(rename = "Yuumi.png")]
    YuumiPng,
    #[serde(rename = "YuumiQ.png")]
    YuumiQPng,
    #[serde(rename = "YuumiR.png")]
    YuumiRPng,
    #[serde(rename = "YuumiW.png")]
    YuumiWPng,
}
