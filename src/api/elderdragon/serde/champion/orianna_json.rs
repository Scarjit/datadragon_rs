...
pub fn serialize(json: &str) -> Result<OriannaJson,Error>{
...
pub struct OriannaJson {
    #[serde(rename = "type")]
    pub orianna_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "OrianaDetonateCommand.png")]
    OrianaDetonateCommandPng,
    #[serde(rename = "OrianaDissonanceCommand.png")]
    OrianaDissonanceCommandPng,
    #[serde(rename = "OrianaIzunaCommand.png")]
    OrianaIzunaCommandPng,
    #[serde(rename = "OrianaRedactCommand.png")]
    OrianaRedactCommandPng,
    #[serde(rename = "OriannaPassive.png")]
    OriannaPassivePng,
    #[serde(rename = "Orianna.png")]
    OriannaPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "OriannaARAM")]
    OriannaAram,
    #[serde(rename = "OriannaCS")]
    OriannaCs,
    #[serde(rename = "OriannaFIRSTBLOOD")]
    OriannaFirstblood,
    #[serde(rename = "OriannaKINGPORO")]
    OriannaKingporo,
    #[serde(rename = "OriannaSIEGE")]
    OriannaSiege,
    #[serde(rename = "OriannaSL")]
    OriannaSl,
    #[serde(rename = "OriannaSR")]
    OriannaSr,
    #[serde(rename = "OriannaTT")]
    OriannaTt,
}
