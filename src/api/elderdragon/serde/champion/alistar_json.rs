...
pub struct AlistarJson {
    #[serde(rename = "type")]
    pub alistar_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "Alistar_E.png")]
    AlistarEPng,
    #[serde(rename = "Alistar.png")]
    AlistarPng,
    #[serde(rename = "FerociousHowl.png")]
    FerociousHowlPng,
    #[serde(rename = "AlistarE.png")]
    FullAlistarEPng,
    #[serde(rename = "Headbutt.png")]
    HeadbuttPng,
    #[serde(rename = "Pulverize.png")]
    PulverizePng,
}
...
#[derive(Serialize, Deserialize)]
pub enum Title {
    #[serde(rename = "AlistarARAM")]
    AlistarAram,
    #[serde(rename = "AlistarCS")]
    AlistarCs,
    #[serde(rename = "AlistarFIRSTBLOOD")]
    AlistarFirstblood,
    #[serde(rename = "AlistarKINGPORO")]
    AlistarKingporo,
    #[serde(rename = "AlistarSIEGE")]
    AlistarSiege,
    #[serde(rename = "AlistarSL")]
    AlistarSl,
    #[serde(rename = "AlistarSR")]
    AlistarSr,
    #[serde(rename = "AlistarTT")]
    AlistarTt,
    Beginner,
}
...
pub enum Effect {
    ...
    #[serde(rename = "{{ e2 }}->{{ e2NL }}")]
    EffectE2E2Nl,
    #[serde(rename = "{{ rdamagereduction }}% -> {{ rdamagereductionNL }}%")]
    EffectRdamagereductionRdamagereductionNl,
    #[serde(rename = "{{ rdamagereduction }}%->{{ rdamagereductionNL }}%")]
    FluffyRdamagereductionRdamagereductionNl,
    #[serde(rename = "%{{ rdamagereduction }} -> %{{ rdamagereductionNL }}")]
    PurpleRdamagereductionRdamagereductionNl,
    #[serde(rename = "{{ rdamagereduction }}&nbsp;% -> {{ rdamagereductionNL }}&nbsp;%")]
    RdamagereductionNbspRdamagereductionNlNbsp,
    #[serde(rename = "{{ rdamagereduction }} % -> {{ rdamagereductionNL }} %")]
    RdamagereductionRdamagereductionNl,
}
