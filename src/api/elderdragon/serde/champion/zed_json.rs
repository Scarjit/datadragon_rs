...
pub fn serialize(json: &str) -> Result<ZedJson,Error>{
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "shadowninja_P.png")]
    ShadowninjaPPng,
    #[serde(rename = "ZedE.png")]
    ZedEPng,
    #[serde(rename = "Zed.png")]
    ZedPng,
    #[serde(rename = "ZedQ.png")]
    ZedQPng,
    #[serde(rename = "ZedR.png")]
    ZedRPng,
    #[serde(rename = "ZedW.png")]
    ZedWPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "KagetoraFIRSTBLOOD")]
    KagetoraFirstblood,
    #[serde(rename = "ZedARAM")]
    ZedAram,
    #[serde(rename = "ZedCS")]
    ZedCs,
    #[serde(rename = "ZedFIRSTBLOOD")]
    ZedFirstblood,
    #[serde(rename = "ZedKINGPORO")]
    ZedKingporo,
    #[serde(rename = "ZedSIEGE")]
    ZedSiege,
    #[serde(rename = "ZedSL")]
    ZedSl,
    #[serde(rename = "ZedSR")]
