...
pub fn serialize(json: &str) -> Result<KaisaJson,Error>{
...
pub struct KaisaJson {
    #[serde(rename = "type")]
    pub kaisa_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "KaisaE.png")]
    KaisaEPng,
    #[serde(rename = "Kaisa_Passive.png")]
    KaisaPassivePng,
    #[serde(rename = "Kaisa.png")]
    KaisaPng,
    #[serde(rename = "KaisaQ.png")]
    KaisaQPng,
    #[serde(rename = "KaisaR.png")]
    KaisaRPng,
    #[serde(rename = "KaisaW.png")]
    KaisaWPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "KaiSaSL")]
    KaiSaSl,
    #[serde(rename = "KaisaARAM")]
    KaisaAram,
    #[serde(rename = "KaisaCS")]
    KaisaCs,
    #[serde(rename = "KaisaFIRSTBLOOD")]
    KaisaFirstblood,
    #[serde(rename = "KaisaKINGPORO")]
    KaisaKingporo,
    #[serde(rename = "KaisaSIEGE")]
    KaisaSiege,
    #[serde(rename = "KaisaSR")]
    KaisaSr,
    #[serde(rename = "KaisaTT")]
    KaisaTt,
}
