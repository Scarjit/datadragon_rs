...
pub fn serialize(json: &str) -> Result<AniviaJson,Error>{
...
pub struct AniviaJson {
    #[serde(rename = "type")]
    pub anivia_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "Anivia_P.png")]
    AniviaPPng,
    #[serde(rename = "Anivia.png")]
    AniviaPng,
    #[serde(rename = "Crystallize.png")]
    CrystallizePng,
    #[serde(rename = "FlashFrost.png")]
    FlashFrostPng,
    #[serde(rename = "Frostbite.png")]
    FrostbitePng,
    #[serde(rename = "GlacialStorm.png")]
    GlacialStormPng,
}
...
#[derive(Serialize, Deserialize)]
pub enum Title {
    #[serde(rename = "AniviaARAM")]
    AniviaAram,
    #[serde(rename = "AniviaCS")]
    AniviaCs,
    #[serde(rename = "AniviaFIRSTBLOOD")]
    AniviaFirstblood,
    #[serde(rename = "AniviaKINGPORO")]
    AniviaKingporo,
    #[serde(rename = "AniviaSIEGE")]
    AniviaSiege,
    #[serde(rename = "AniviaSL")]
    AniviaSl,
    #[serde(rename = "AniviaSR")]
    AniviaSr,
    #[serde(rename = "AniviaTT")]
    AniviaTt,
    Beginner,
}
