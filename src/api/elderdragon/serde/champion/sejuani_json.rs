...
pub fn serialize(json: &str) -> Result<SejuaniJson,Error>{
...
pub struct SejuaniJson {
    #[serde(rename = "type")]
    pub sejuani_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "SejuaniE.png")]
    SejuaniEPng,
    #[serde(rename = "Sejuani_passive.png")]
    SejuaniPassivePng,
    #[serde(rename = "Sejuani.png")]
    SejuaniPng,
    #[serde(rename = "SejuaniQ.png")]
    SejuaniQPng,
    #[serde(rename = "SejuaniR.png")]
    SejuaniRPng,
    #[serde(rename = "SejuaniW.png")]
    SejuaniWPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "SejuaniARAM")]
    SejuaniAram,
    #[serde(rename = "SejuaniCS")]
    SejuaniCs,
    #[serde(rename = "SejuaniFIRSTBLOOD")]
    SejuaniFirstblood,
    #[serde(rename = "SejuaniKINGPORO")]
    SejuaniKingporo,
    #[serde(rename = "SejuaniSIEGE")]
    SejuaniSiege,
    #[serde(rename = "SejuaniSL")]
    SejuaniSl,
    #[serde(rename = "SejuaniSR")]
    SejuaniSr,
    #[serde(rename = "SejuaniTT")]
    SejuaniTt,
}
