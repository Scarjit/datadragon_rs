...
pub fn serialize(json: &str) -> Result<XerathJson,Error>{
...
pub struct XerathJson {
    #[serde(rename = "type")]
    pub xerath_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "XerathArcaneBarrage2.png")]
    XerathArcaneBarrage2Png,
    #[serde(rename = "XerathArcanopulseChargeUp.png")]
    XerathArcanopulseChargeUpPng,
    #[serde(rename = "XerathLocusOfPower2.png")]
    XerathLocusOfPower2Png,
    #[serde(rename = "XerathMageSpear.png")]
    XerathMageSpearPng,
    #[serde(rename = "Xerath_Passive1.png")]
    XerathPassive1Png,
    #[serde(rename = "Xerath.png")]
    XerathPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "XerathARAM")]
    XerathAram,
    #[serde(rename = "XerathCS")]
    XerathCs,
    #[serde(rename = "XerathFIRSTBLOOD")]
    XerathFirstblood,
    #[serde(rename = "XerathKINGPORO")]
    XerathKingporo,
    #[serde(rename = "XerathSIEGE")]
    XerathSiege,
    #[serde(rename = "XerathSL")]
    XerathSl,
    #[serde(rename = "XerathSR")]
    XerathSr,
    #[serde(rename = "XerathTT")]
    XerathTt,
}
