...
pub fn serialize(json: &str) -> Result<BlitzcrankJson,Error>{
...
pub struct BlitzcrankJson {
    #[serde(rename = "type")]
    pub blitzcrank_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "Blitzcrank_ManaBarrier.png")]
    BlitzcrankManaBarrierPng,
    #[serde(rename = "Blitzcrank.png")]
    BlitzcrankPng,
    #[serde(rename = "Overdrive.png")]
    OverdrivePng,
    #[serde(rename = "PowerFist.png")]
    PowerFistPng,
    #[serde(rename = "RocketGrab.png")]
    RocketGrabPng,
    #[serde(rename = "StaticField.png")]
    StaticFieldPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "BlitzcrankARAM")]
    BlitzcrankAram,
    #[serde(rename = "BlitzcrankCS")]
    BlitzcrankCs,
    #[serde(rename = "BlitzcrankFIRSTBLOOD")]
    BlitzcrankFirstblood,
    #[serde(rename = "BlitzcrankKINGPORO")]
    BlitzcrankKingporo,
    #[serde(rename = "BlitzcrankSIEGE")]
    BlitzcrankSiege,
    #[serde(rename = "BlitzcrankSL")]
    BlitzcrankSl,
    #[serde(rename = "BlitzcrankSR")]
    BlitzcrankSr,
    #[serde(rename = "BlitzcrankTT")]
    BlitzcrankTt,
}
