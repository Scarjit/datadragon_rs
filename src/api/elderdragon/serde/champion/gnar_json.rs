...
pub fn serialize(json: &str) -> Result<GnarJson,Error>{
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "GnarE.png")]
    GnarEPng,
    #[serde(rename = "Gnar_Passive.png")]
    GnarPassivePng,
    #[serde(rename = "Gnar.png")]
    GnarPng,
    #[serde(rename = "GnarQ.png")]
    GnarQPng,
    #[serde(rename = "GnarR.png")]
    GnarRPng,
    #[serde(rename = "GnarW.png")]
    GnarWPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "GnarARAM")]
    GnarAram,
    #[serde(rename = "GnarCS")]
    GnarCs,
    #[serde(rename = "GnarFIRSTBLOOD")]
    GnarFirstblood,
    #[serde(rename = "GnarKINGPORO")]
    GnarKingporo,
    #[serde(rename = "GnarSIEGE")]
    GnarSiege,
    #[serde(rename = "GnarSL")]
    GnarSl,
    #[serde(rename = "GnarSR")]
