...
pub fn serialize(json: &str) -> Result<KogMawJson,Error>{
...
pub struct KogMawJson {
    #[serde(rename = "type")]
    pub kog_maw_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "KogMawBioArcaneBarrage.png")]
    KogMawBioArcaneBarragePng,
    #[serde(rename = "KogMaw_IcathianSurprise.png")]
    KogMawIcathianSurprisePng,
    #[serde(rename = "KogMawLivingArtillery.png")]
    KogMawLivingArtilleryPng,
    #[serde(rename = "KogMaw.png")]
    KogMawPng,
    #[serde(rename = "KogMawQ.png")]
    KogMawQPng,
    #[serde(rename = "KogMawVoidOoze.png")]
    KogMawVoidOozePng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "KogMawARAM")]
    KogMawAram,
    #[serde(rename = "KogMawCS")]
    KogMawCs,
    #[serde(rename = "KogMawKINGPORO")]
    KogMawKingporo,
    #[serde(rename = "KogMawPRJ17")]
    KogMawPrj17,
    #[serde(rename = "KogMawSIEGE")]
    KogMawSiege,
    #[serde(rename = "KogMawSL")]
    KogMawSl,
    #[serde(rename = "KogmawFIRSTBLOOD")]
    KogmawFirstblood,
    #[serde(rename = "KogmawSR")]
    KogmawSr,
    #[serde(rename = "KogmawTT")]
    KogmawTt,
}
