...
pub fn serialize(json: &str) -> Result<JannaJson,Error>{
...
pub struct JannaJson {
    #[serde(rename = "type")]
    pub janna_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "EyeOfTheStorm.png")]
    EyeOfTheStormPng,
    #[serde(rename = "HowlingGale.png")]
    HowlingGalePng,
    #[serde(rename = "Janna.png")]
    JannaPng,
    #[serde(rename = "Janna_Tailwind.png")]
    JannaTailwindPng,
    #[serde(rename = "ReapTheWhirlwind.png")]
    ReapTheWhirlwindPng,
    #[serde(rename = "SowTheWind.png")]
    SowTheWindPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "JannaARAM")]
    JannaAram,
    #[serde(rename = "JannaCS")]
    JannaCs,
    #[serde(rename = "JannaFIRSTBLOOD")]
    JannaFirstblood,
    #[serde(rename = "JannaKINGPORO")]
    JannaKingporo,
    #[serde(rename = "JannaSG")]
    JannaSg,
    #[serde(rename = "JannaSIEGE")]
    JannaSiege,
    #[serde(rename = "JannaSL")]
    JannaSl,
    #[serde(rename = "JannaSR")]
    JannaSr,
    #[serde(rename = "JannaTT")]
    JannaTt,
}
