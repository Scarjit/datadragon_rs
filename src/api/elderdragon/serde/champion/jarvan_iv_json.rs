...
pub fn serialize(json: &str) -> Result<JarvanIvJson,Error>{
...
pub struct JarvanIvJson {
    #[serde(rename = "type")]
    pub jarvan_iv_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "JarvanIVCataclysm.png")]
    JarvanIvCataclysmPng,
    #[serde(rename = "JarvanIVDemacianStandard.png")]
    JarvanIvDemacianStandardPng,
    #[serde(rename = "JarvanIVDragonStrike.png")]
    JarvanIvDragonStrikePng,
    #[serde(rename = "JarvanIVGoldenAegis.png")]
    JarvanIvGoldenAegisPng,
    #[serde(rename = "JarvanIV_MartialCadence.png")]
    JarvanIvMartialCadencePng,
    #[serde(rename = "JarvanIV.png")]
    JarvanIvPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "JarvanIVARAM")]
    JarvanIvaram,
    #[serde(rename = "JarvanIVCS")]
    JarvanIvcs,
    #[serde(rename = "JarvanIVFIRSTBLOOD")]
    JarvanIvfirstblood,
    #[serde(rename = "JarvanIVKINGPORO")]
    JarvanIvkingporo,
    #[serde(rename = "JarvanIVSIEGE")]
    JarvanIvsiege,
    #[serde(rename = "JarvanIVSL")]
    JarvanIvsl,
    #[serde(rename = "JarvanIVSR")]
    JarvanIvsr,
    #[serde(rename = "JarvanIVTT")]
    JarvanIvtt,
}
...
#[derive(Serialize, Deserialize)]
pub enum SpellId {
    #[serde(rename = "JarvanIVCataclysm")]
    JarvanIvCataclysm,
    #[serde(rename = "JarvanIVDemacianStandard")]
    JarvanIvDemacianStandard,
    #[serde(rename = "JarvanIVDragonStrike")]
    JarvanIvDragonStrike,
    #[serde(rename = "JarvanIVGoldenAegis")]
    JarvanIvGoldenAegis,
}
