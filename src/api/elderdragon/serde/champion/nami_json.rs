...
pub fn serialize(json: &str) -> Result<NamiJson,Error>{
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "NamiE.png")]
    NamiEPng,
    #[serde(rename = "NamiPassive.png")]
    NamiPassivePng,
    #[serde(rename = "Nami.png")]
    NamiPng,
    #[serde(rename = "NamiQ.png")]
    NamiQPng,
    #[serde(rename = "NamiR.png")]
    NamiRPng,
    #[serde(rename = "NamiW.png")]
    NamiWPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "NamiARAM")]
    NamiAram,
    #[serde(rename = "NamiCS")]
    NamiCs,
    #[serde(rename = "namiFIRSTBLOOD")]
    NamiFirstblood,
    #[serde(rename = "NamiKINGPORO")]
    NamiKingporo,
    #[serde(rename = "NamiSIEGE")]
    NamiSiege,
    #[serde(rename = "NamiSL")]
    NamiSl,
    #[serde(rename = "namiSR")]
