...
pub fn serialize(json: &str) -> Result<TristanaJson,Error>{
...
pub struct TristanaJson {
    #[serde(rename = "type")]
    pub tristana_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "TristanaE.png")]
    TristanaEPng,
    #[serde(rename = "Tristana_Passive.png")]
    TristanaPassivePng,
    #[serde(rename = "Tristana.png")]
    TristanaPng,
    #[serde(rename = "TristanaQ.png")]
    TristanaQPng,
    #[serde(rename = "TristanaR.png")]
    TristanaRPng,
    #[serde(rename = "TristanaW.png")]
    TristanaWPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "TristanaARAM")]
    TristanaAram,
    #[serde(rename = "TristanaCS")]
    TristanaCs,
    #[serde(rename = "TristanaFIRSTBLOOD")]
    TristanaFirstblood,
    #[serde(rename = "TristanaKINGPORO")]
    TristanaKingporo,
    #[serde(rename = "TristanaPRJ17")]
    TristanaPrj17,
    #[serde(rename = "TristanaSIEGE")]
    TristanaSiege,
    #[serde(rename = "TristanaSL")]
    TristanaSl,
    #[serde(rename = "TristanaSR")]
    TristanaSr,
    #[serde(rename = "TristanaTT")]
    TristanaTt,
}

#[derive(Serialize, Deserialize)]
pub enum CooldownBurn {
    #[serde(rename = "120/110/100")]
    The120110100,
    #[serde(rename = "16/15.5/15/14.5/14")]
    The161551514514,
    #[serde(rename = "20/19/18/17/16")]
    The2019181716,
    #[serde(rename = "22/20/18/16/14")]
    The2220181614,
}
