...
pub fn serialize(json: &str) -> Result<EvelynnJson,Error>{
...
pub struct EvelynnJson {
    #[serde(rename = "type")]
    pub evelynn_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "EvelynnE.png")]
    EvelynnEPng,
    #[serde(rename = "Evelynn_Passive.png")]
    EvelynnPassivePng,
    #[serde(rename = "Evelynn.png")]
    EvelynnPng,
    #[serde(rename = "EvelynnQ.png")]
    EvelynnQPng,
    #[serde(rename = "EvelynnR.png")]
    EvelynnRPng,
    #[serde(rename = "EvelynnW.png")]
    EvelynnWPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "EvelynnARAM")]
    EvelynnAram,
    #[serde(rename = "EvelynnCS")]
    EvelynnCs,
    #[serde(rename = "EvelynnFIRSTBLOOD")]
    EvelynnFirstblood,
    #[serde(rename = "EvelynnKINGPORO")]
    EvelynnKingporo,
    #[serde(rename = "EvelynnSIEGE")]
    EvelynnSiege,
    #[serde(rename = "EvelynnSL")]
    EvelynnSl,
    #[serde(rename = "EvelynnSR")]
    EvelynnSr,
    #[serde(rename = "EvelynnTT")]
    EvelynnTt,
}
