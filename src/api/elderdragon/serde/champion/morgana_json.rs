...
pub fn serialize(json: &str) -> Result<MorganaJson,Error>{
...
pub struct MorganaJson {
    #[serde(rename = "type")]
    pub morgana_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "FallenAngel_Empathize.png")]
    FallenAngelEmpathizePng,
    #[serde(rename = "MorganaE.png")]
    MorganaEPng,
    #[serde(rename = "Morgana.png")]
    MorganaPng,
    #[serde(rename = "MorganaQ.png")]
    MorganaQPng,
    #[serde(rename = "MorganaR.png")]
    MorganaRPng,
    #[serde(rename = "MorganaW.png")]
    MorganaWPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "MorganaARAM")]
    MorganaAram,
    #[serde(rename = "MorganaCS")]
    MorganaCs,
    #[serde(rename = "MorganaFIRSTBLOOD")]
    MorganaFirstblood,
    #[serde(rename = "MorganaKINGPORO")]
    MorganaKingporo,
    #[serde(rename = "MorganaSIEGE")]
    MorganaSiege,
    #[serde(rename = "MorganaSL")]
    MorganaSl,
    #[serde(rename = "MorganaSR")]
    MorganaSr,
    #[serde(rename = "MorganaTT")]
    MorganaTt,
}
