...
pub fn serialize(json: &str) -> Result<KhazixJson,Error>{
...
pub struct KhazixJson {
    #[serde(rename = "type")]
    pub khazix_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "KhazixE.png")]
    KhazixEPng,
    #[serde(rename = "Khazix_P.png")]
    KhazixPPng,
    #[serde(rename = "Khazix.png")]
    KhazixPng,
    #[serde(rename = "KhazixQ.png")]
    KhazixQPng,
    #[serde(rename = "KhazixR.png")]
    KhazixRPng,
    #[serde(rename = "KhazixW.png")]
    KhazixWPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "KhaZixSL")]
    KhaZixSl,
    #[serde(rename = "KhazixARAM")]
    KhazixAram,
    #[serde(rename = "KhazixCS")]
    KhazixCs,
    #[serde(rename = "KhazixFIRSTBLOOD")]
    KhazixFirstblood,
    #[serde(rename = "KhazixKINGPORO")]
    KhazixKingporo,
    #[serde(rename = "KhazixSIEGE")]
    KhazixSiege,
    #[serde(rename = "KhazixSR")]
    KhazixSr,
    #[serde(rename = "KhazixTT")]
    KhazixTt,
    #[serde(rename = "RainbowScytherFIRSTBLOOD")]
    RainbowScytherFirstblood,
}
...
pub enum Effect {
    ...
    #[serde(rename = "{{ e2 }}->{{ e2NL }}")]
    EffectE2E2Nl,
    #[serde(rename = "{{ evolutionsavailable }}->{{ evolutionsavailableNL }}")]
    EffectEvolutionsavailableEvolutionsavailableNl,
    #[serde(rename = "{{ evolutionsavailable }} -> {{ evolutionsavailableNL }}")]
    EvolutionsavailableEvolutionsavailableNl,
}
