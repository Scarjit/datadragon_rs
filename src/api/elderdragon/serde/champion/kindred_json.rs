...
pub fn serialize(json: &str) -> Result<KindredJson,Error>{
...
pub struct KindredJson {
    #[serde(rename = "type")]
    pub kindred_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "KindredEWrapper.png")]
    KindredEWrapperPng,
    #[serde(rename = "Kindred_Passive.png")]
    KindredPassivePng,
    #[serde(rename = "Kindred.png")]
    KindredPng,
    #[serde(rename = "KindredQ.png")]
    KindredQPng,
    #[serde(rename = "KindredR.png")]
    KindredRPng,
    #[serde(rename = "KindredW.png")]
    KindredWPng,
}
...
#[derive(Serialize, Deserialize)]
pub enum Title {
    #[serde(rename = "KindredARAM")]
    KindredAram,
    #[serde(rename = "KindredCS")]
    KindredCs,
    #[serde(rename = "KindredFIRSTBLOOD")]
    KindredFirstblood,
    #[serde(rename = "KindredKINGPORO")]
    KindredKingporo,
    #[serde(rename = "KindredSIEGE")]
    KindredSiege,
    #[serde(rename = "KindredSL")]
    KindredSl,
    #[serde(rename = "KindredSR")]
    KindredSr,
    #[serde(rename = "KindredTT")]
    KindredTt,
}
