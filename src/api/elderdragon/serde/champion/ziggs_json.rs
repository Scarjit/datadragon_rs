...
pub fn serialize(json: &str) -> Result<ZiggsJson,Error>{
...
pub struct ZiggsJson {
    #[serde(rename = "type")]
    pub ziggs_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "ZiggsE.png")]
    ZiggsEPng,
    #[serde(rename = "ZiggsPassiveReady.png")]
    ZiggsPassiveReadyPng,
    #[serde(rename = "Ziggs.png")]
    ZiggsPng,
    #[serde(rename = "ZiggsQ.png")]
    ZiggsQPng,
    #[serde(rename = "ZiggsR.png")]
    ZiggsRPng,
    #[serde(rename = "ZiggsW.png")]
    ZiggsWPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "ZiggsARAM")]
    ZiggsAram,
    #[serde(rename = "ZiggsCS")]
    ZiggsCs,
    #[serde(rename = "ZiggsFIRSTBLOOD")]
    ZiggsFirstblood,
    #[serde(rename = "ZiggsKINGPORO")]
    ZiggsKingporo,
    #[serde(rename = "ZiggsODYSSEY")]
    ZiggsOdyssey,
    #[serde(rename = "ZiggsSIEGE")]
    ZiggsSiege,
    #[serde(rename = "ZiggsSL")]
    ZiggsSl,
    #[serde(rename = "ZiggsSR")]
    ZiggsSr,
    #[serde(rename = "ZiggsTT")]
    ZiggsTt,
}
