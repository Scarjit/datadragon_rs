...
pub fn serialize(json: &str) -> Result<ShyvanaJson,Error>{
...
pub struct ShyvanaJson {
    #[serde(rename = "type")]
    pub shyvana_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "ShyvanaDoubleAttack.png")]
    ShyvanaDoubleAttackPng,
    #[serde(rename = "ShyvanaFireball.png")]
    ShyvanaFireballPng,
    #[serde(rename = "ShyvanaImmolationAura.png")]
    ShyvanaImmolationAuraPng,
    #[serde(rename = "Shyvana.png")]
    ShyvanaPng,
    #[serde(rename = "ShyvanaReinforcedScales.png")]
    ShyvanaReinforcedScalesPng,
    #[serde(rename = "ShyvanaTransformCast.png")]
    ShyvanaTransformCastPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "ShyvanaARAM")]
    ShyvanaAram,
    #[serde(rename = "ShyvanaCS")]
    ShyvanaCs,
    #[serde(rename = "ShyvanaFIRSTBLOOD")]
    ShyvanaFirstblood,
    #[serde(rename = "ShyvanaKINGPORO")]
    ShyvanaKingporo,
    #[serde(rename = "ShyvanaSIEGE")]
    ShyvanaSiege,
    #[serde(rename = "ShyvanaSL")]
    ShyvanaSl,
    #[serde(rename = "ShyvanaSR")]
    ShyvanaSr,
    #[serde(rename = "ShyvanaTT")]
    ShyvanaTt,
}
