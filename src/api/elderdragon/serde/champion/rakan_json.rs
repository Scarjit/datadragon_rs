...
pub fn serialize(json: &str) -> Result<RakanJson,Error>{
...
pub struct RakanJson {
    #[serde(rename = "type")]
    rakan_json_type: GroupEnum,
    format: Format,
    version: Version,
    data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "RakanE.png")]
    RakanEPng,
    #[serde(rename = "Rakan_P.png")]
    RakanPPng,
    #[serde(rename = "Rakan.png")]
    RakanPng,
    #[serde(rename = "RakanQ.png")]
    RakanQPng,
    #[serde(rename = "RakanR.png")]
    RakanRPng,
    #[serde(rename = "RakanW.png")]
    RakanWPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "RakanARAM")]
    RakanAram,
    #[serde(rename = "RakanCS")]
    RakanCs,
    #[serde(rename = "RakanKINGPORO")]
    RakanKingporo,
    #[serde(rename = "RakanSIEGE")]
    RakanSiege,
    #[serde(rename = "RakanSL")]
    RakanSl,
    #[serde(rename = "RakanSR")]
    RakanSr,
    #[serde(rename = "RakanTT")]
    RakanTt,
}
...
#[derive(Serialize, Deserialize)]
pub enum Effect {
    #[serde(rename = "{{ basecost }} -> {{ basecostNL }}")]
    BasecostBasecostNl,
