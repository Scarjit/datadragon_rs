...
pub fn serialize(json: &str) -> Result<VayneJson,Error>{
...
pub struct VayneJson {
    #[serde(rename = "type")]
    pub vayne_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "VayneCondemn.png")]
    VayneCondemnPng,
    #[serde(rename = "VayneInquisition.png")]
    VayneInquisitionPng,
    #[serde(rename = "Vayne_NightHunter.png")]
    VayneNightHunterPng,
    #[serde(rename = "Vayne.png")]
    VaynePng,
    #[serde(rename = "VayneSilveredBolts.png")]
    VayneSilveredBoltsPng,
    #[serde(rename = "VayneTumble.png")]
    VayneTumblePng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "VayneARAM")]
    VayneAram,
    #[serde(rename = "VayneCS")]
    VayneCs,
    #[serde(rename = "VayneFIRSTBLOOD")]
    VayneFirstblood,
    #[serde(rename = "VayneKINGPORO")]
    VayneKingporo,
    #[serde(rename = "VaynePRJ17")]
    VaynePrj17,
    #[serde(rename = "VayneSIEGE")]
    VayneSiege,
    #[serde(rename = "VayneSL")]
    VayneSl,
    #[serde(rename = "VayneSR")]
    VayneSr,
    #[serde(rename = "VayneTT")]
    VayneTt,
}
