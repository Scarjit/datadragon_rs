...
pub fn serialize(json: &str) -> Result<LeeSinJson,Error>{
...
pub struct LeeSinJson {
    #[serde(rename = "type")]
    pub lee_sin_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "BlindMonkEOne.png")]
    BlindMonkEOnePng,
    #[serde(rename = "BlindMonkQOne.png")]
    BlindMonkQOnePng,
    #[serde(rename = "BlindMonkRKick.png")]
    BlindMonkRKickPng,
    #[serde(rename = "BlindMonkWOne.png")]
    BlindMonkWOnePng,
    #[serde(rename = "LeeSinPassive.png")]
    LeeSinPassivePng,
    #[serde(rename = "LeeSin.png")]
    LeeSinPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "LeeSinARAM")]
    LeeSinAram,
    #[serde(rename = "LeeSinCS")]
    LeeSinCs,
    #[serde(rename = "LeeSinFIRSTBLOOD")]
    LeeSinFirstblood,
    #[serde(rename = "LeeSinKINGPORO")]
    LeeSinKingporo,
    #[serde(rename = "LeeSinSIEGE")]
    LeeSinSiege,
    #[serde(rename = "LeeSinSL")]
    LeeSinSl,
    #[serde(rename = "LeeSinSR")]
    LeeSinSr,
    #[serde(rename = "LeeSinTT")]
    LeeSinTt,
}
