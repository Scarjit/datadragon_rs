...
pub fn serialize(json: &str) -> Result<AnnieJson,Error>{
...
pub struct AnnieJson {
    #[serde(rename = "type")]
    pub annie_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "AnnieE.png")]
    AnnieEPng,
    #[serde(rename = "Annie_Passive.png")]
    AnniePassivePng,
    #[serde(rename = "Annie.png")]
    AnniePng,
    #[serde(rename = "AnnieQ.png")]
    AnnieQPng,
    #[serde(rename = "AnnieR.png")]
    AnnieRPng,
    #[serde(rename = "AnnieW.png")]
    AnnieWPng,
}
...
#[derive(Serialize, Deserialize)]
pub enum Title {
    #[serde(rename = "AnnieARAM")]
    AnnieAram,
    #[serde(rename = "AnnieCS")]
    AnnieCs,
    #[serde(rename = "AnnieFIRSTBLOOD")]
    AnnieFirstblood,
    #[serde(rename = "AnnieKINGPORO")]
    AnnieKingporo,
    #[serde(rename = "AnnieSIEGE")]
    AnnieSiege,
    #[serde(rename = "AnnieSL")]
    AnnieSl,
    #[serde(rename = "AnnieSR")]
    AnnieSr,
    #[serde(rename = "AnnieTT")]
    AnnieTt,
    Beginner,
}
