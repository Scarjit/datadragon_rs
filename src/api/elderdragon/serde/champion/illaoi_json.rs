...
pub fn serialize(json: &str) -> Result<IllaoiJson,Error>{
...
pub struct IllaoiJson {
    #[serde(rename = "type")]
    illaoi_json_type: GroupEnum,
    format: Format,
    version: Version,
    data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "IllaoiE.png")]
    IllaoiEPng,
    #[serde(rename = "Illaoi_P.png")]
    IllaoiPPng,
    #[serde(rename = "Illaoi.png")]
    IllaoiPng,
    #[serde(rename = "IllaoiQ.png")]
    IllaoiQPng,
    #[serde(rename = "IllaoiR.png")]
    IllaoiRPng,
    #[serde(rename = "IllaoiW.png")]
    IllaoiWPng,
}
...
#[derive(Serialize, Deserialize)]
pub enum Title {
    #[serde(rename = "IllaoiARAM")]
    IllaoiAram,
    #[serde(rename = "IllaoiCS")]
    IllaoiCs,
    #[serde(rename = "IllaoiFIRSTBLOOD")]
    IllaoiFirstblood,
    #[serde(rename = "IllaoiKINGPORO")]
    IllaoiKingporo,
    #[serde(rename = "IllaoiSIEGE")]
    IllaoiSiege,
    #[serde(rename = "IllaoiSL")]
    IllaoiSl,
    #[serde(rename = "IllaoiSR")]
    IllaoiSr,
    #[serde(rename = "IllaoiTT")]
    IllaoiTt,
}
