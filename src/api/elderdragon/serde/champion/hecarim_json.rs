...
pub fn serialize(json: &str) -> Result<HecarimJson,Error>{
...
pub struct HecarimJson {
    #[serde(rename = "type")]
    pub hecarim_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "Hecarim_Passive.png")]
    HecarimPassivePng,
    #[serde(rename = "Hecarim.png")]
    HecarimPng,
    #[serde(rename = "HecarimRamp.png")]
    HecarimRampPng,
    #[serde(rename = "HecarimRapidSlash.png")]
    HecarimRapidSlashPng,
    #[serde(rename = "HecarimUlt.png")]
    HecarimUltPng,
    #[serde(rename = "HecarimW.png")]
    HecarimWPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "HecarimARAM")]
    HecarimAram,
    #[serde(rename = "HecarimCS")]
    HecarimCs,
    #[serde(rename = "HecarimFIRSTBLOOD")]
    HecarimFirstblood,
    #[serde(rename = "HecarimKINGPORO")]
    HecarimKingporo,
    #[serde(rename = "HecarimSIEGE")]
    HecarimSiege,
    #[serde(rename = "HecarimSL")]
    HecarimSl,
    #[serde(rename = "HecarimSR")]
    HecarimSr,
    #[serde(rename = "HecarimTT")]
    HecarimTt,
}
