...
pub fn serialize(json: &str) -> Result<TeemoJson,Error>{
...
pub struct TeemoJson {
    #[serde(rename = "type")]
    pub teemo_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "BlindingDart.png")]
    BlindingDartPng,
    #[serde(rename = "MoveQuick.png")]
    MoveQuickPng,
    #[serde(rename = "Teemo_P.png")]
    TeemoPPng,
    #[serde(rename = "Teemo.png")]
    TeemoPng,
    #[serde(rename = "TeemoRCast.png")]
    TeemoRCastPng,
    #[serde(rename = "ToxicShot.png")]
    ToxicShotPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "TeemoARAM")]
    TeemoAram,
    #[serde(rename = "TeemoCS")]
    TeemoCs,
    #[serde(rename = "TeemoFIRSTBLOOD")]
    TeemoFirstblood,
    #[serde(rename = "TeemoKINGPORO")]
    TeemoKingporo,
    #[serde(rename = "TeemoSIEGE")]
    TeemoSiege,
    #[serde(rename = "TeemoSL")]
    TeemoSl,
    #[serde(rename = "TeemoSR")]
    TeemoSr,
    #[serde(rename = "TeemoTT")]
    TeemoTt,
}
