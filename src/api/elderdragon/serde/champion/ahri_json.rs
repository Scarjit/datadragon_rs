...
pub fn serialize(json: &str) -> Result<AhriJson,Error>{
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "AhriFoxFire.png")]
    AhriFoxFirePng,
    #[serde(rename = "AhriOrbofDeception.png")]
    AhriOrbofDeceptionPng,
    #[serde(rename = "Ahri.png")]
    AhriPng,
    #[serde(rename = "AhriSeduce.png")]
    AhriSeducePng,
    #[serde(rename = "Ahri_SoulEater2.png")]
    AhriSoulEater2Png,
    #[serde(rename = "AhriTumble.png")]
    AhriTumblePng,
}
...
#[derive(Serialize, Deserialize)]
pub enum Title {
    #[serde(rename = "AhriARAM")]
    AhriAram,
    #[serde(rename = "AhriCS")]
    AhriCs,
    #[serde(rename = "AhriFIRSTBLOOD")]
    AhriFirstblood,
    #[serde(rename = "AhriKINGPORO")]
    AhriKingporo,
    #[serde(rename = "AhriNPE")]
    AhriNpe,
    #[serde(rename = "AhriSG")]
    AhriSg,
    #[serde(rename = "AhriSIEGE")]
    AhriSiege,
    #[serde(rename = "AhriSL")]
    AhriSl,
    #[serde(rename = "AhriSR")]
