...
pub fn serialize(json: &str) -> Result<TwistedFateJson,Error>{
...
pub struct TwistedFateJson {
    #[serde(rename = "type")]
    pub twisted_fate_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "Cardmaster_SealFate.png")]
    CardmasterSealFatePng,
    #[serde(rename = "CardmasterStack.png")]
    CardmasterStackPng,
    #[serde(rename = "Destiny.png")]
    DestinyPng,
    #[serde(rename = "PickACard.png")]
    PickACardPng,
    #[serde(rename = "TwistedFate.png")]
    TwistedFatePng,
    #[serde(rename = "WildCards.png")]
    WildCardsPng,
}
