...
pub fn serialize(json: &str) -> Result<FizzJson,Error>{
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "FizzE.png")]
    FizzEPng,
    #[serde(rename = "Fizz_P.png")]
    FizzPPng,
    #[serde(rename = "Fizz.png")]
    FizzPng,
    #[serde(rename = "FizzQ.png")]
    FizzQPng,
    #[serde(rename = "FizzR.png")]
    FizzRPng,
    #[serde(rename = "FizzW.png")]
    FizzWPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "FizzARAM")]
    FizzAram,
    #[serde(rename = "FizzCS")]
    FizzCs,
    #[serde(rename = "FizzFIRSTBLOOD")]
    FizzFirstblood,
    #[serde(rename = "FizzKINGPORO")]
    FizzKingporo,
    #[serde(rename = "FizzSIEGE")]
    FizzSiege,
    #[serde(rename = "FizzSL")]
    FizzSl,
    #[serde(rename = "FizzSR")]
