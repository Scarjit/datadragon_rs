...
pub fn serialize(json: &str) -> Result<CassiopeiaJson,Error>{
...
pub struct CassiopeiaJson {
    #[serde(rename = "type")]
    pub cassiopeia_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "CassiopeiaE.png")]
    CassiopeiaEPng,
    #[serde(rename = "Cassiopeia_Passive.png")]
    CassiopeiaPassivePng,
    #[serde(rename = "Cassiopeia.png")]
    CassiopeiaPng,
    #[serde(rename = "CassiopeiaQ.png")]
    CassiopeiaQPng,
    #[serde(rename = "CassiopeiaR.png")]
    CassiopeiaRPng,
    #[serde(rename = "CassiopeiaW.png")]
    CassiopeiaWPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "CassiopeiaARAM")]
    CassiopeiaAram,
    #[serde(rename = "CassiopeiaCS")]
    CassiopeiaCs,
    #[serde(rename = "CassiopeiaFIRSTBLOOD")]
    CassiopeiaFirstblood,
    #[serde(rename = "CassiopeiaKINGPORO")]
    CassiopeiaKingporo,
    #[serde(rename = "CassiopeiaSIEGE")]
    CassiopeiaSiege,
    #[serde(rename = "CassiopeiaSL")]
    CassiopeiaSl,
    #[serde(rename = "CassiopeiaSR")]
    CassiopeiaSr,
    #[serde(rename = "CassiopeiaTT")]
    CassiopeiaTt,
}
