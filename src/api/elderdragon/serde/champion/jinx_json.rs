...
pub fn serialize(json: &str) -> Result<JinxJson,Error>{
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "JinxE.png")]
    JinxEPng,
    #[serde(rename = "Jinx_Passive.png")]
    JinxPassivePng,
    #[serde(rename = "Jinx.png")]
    JinxPng,
    #[serde(rename = "JinxQ.png")]
    JinxQPng,
    #[serde(rename = "JinxR.png")]
    JinxRPng,
    #[serde(rename = "JinxW.png")]
    JinxWPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "JinxARAM")]
    JinxAram,
    #[serde(rename = "JinxCS")]
    JinxCs,
    #[serde(rename = "JinxFIRSTBLOOD")]
    JinxFirstblood,
    #[serde(rename = "JinxKINGPORO")]
    JinxKingporo,
    #[serde(rename = "JinxODYSSEY")]
    JinxOdyssey,
    #[serde(rename = "JinxPRJ17")]
    JinxPrj17,
    #[serde(rename = "JinxSG")]
    JinxSg,
    #[serde(rename = "JinxSIEGE")]
    JinxSiege,
    #[serde(rename = "JinxSL")]
    JinxSl,
    #[serde(rename = "JinxSR")]
