...
pub fn serialize(json: &str) -> Result<ZacJson,Error>{
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "ZacE.png")]
    ZacEPng,
    #[serde(rename = "ZacPassive.png")]
    ZacPassivePng,
    #[serde(rename = "Zac.png")]
    ZacPng,
    #[serde(rename = "ZacQ.png")]
    ZacQPng,
    #[serde(rename = "ZacR.png")]
    ZacRPng,
    #[serde(rename = "ZacW.png")]
    ZacWPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "ZacARAM")]
    ZacAram,
    #[serde(rename = "ZacCS")]
    ZacCs,
    #[serde(rename = "ZacFIRSTBLOOD")]
    ZacFirstblood,
    #[serde(rename = "ZacKINGPORO")]
    ZacKingporo,
    #[serde(rename = "ZacSIEGE")]
    ZacSiege,
    #[serde(rename = "ZacSL")]
    ZacSl,
    #[serde(rename = "ZacSR")]
