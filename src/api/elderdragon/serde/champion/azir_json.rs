...
pub fn serialize(json: &str) -> Result<AzirJson,Error>{
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "AzirEWrapper.png")]
    AzirEWrapperPng,
    #[serde(rename = "Azir_Passive.png")]
    AzirPassivePng,
    #[serde(rename = "Azir.png")]
    AzirPng,
    #[serde(rename = "AzirQWrapper.png")]
    AzirQWrapperPng,
    #[serde(rename = "AzirR.png")]
    AzirRPng,
    #[serde(rename = "AzirW.png")]
    AzirWPng,
}
...
#[derive(Serialize, Deserialize)]
pub enum Title {
    #[serde(rename = "AhriFIRSTBLOOD")]
    AhriFirstblood,
    #[serde(rename = "AzirARAM")]
    AzirAram,
    #[serde(rename = "AzirCS")]
    AzirCs,
    #[serde(rename = "AzirFIRSTBLOOD")]
    AzirFirstblood,
    #[serde(rename = "AzirKINGPORO")]
    AzirKingporo,
    #[serde(rename = "AzirSIEGE")]
    AzirSiege,
    #[serde(rename = "AzirSL")]
    AzirSl,
    #[serde(rename = "AzirSR")]
...
pub enum CooldownBurn {
    #[serde(rename = "120/105/90")]
    The12010590,
    #[serde(rename = "1.5")]
    The15,
    #[serde(rename = "15/13/11/9/7")]
    The15131197,
    #[serde(rename = "19/18/17/16/15")]
    The1918171615,
}
