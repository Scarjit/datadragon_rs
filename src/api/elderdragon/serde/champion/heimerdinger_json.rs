...
pub fn serialize(json: &str) -> Result<HeimerdingerJson,Error>{
...
pub struct HeimerdingerJson {
    #[serde(rename = "type")]
    pub heimerdinger_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "HeimerdingerE.png")]
    HeimerdingerEPng,
    #[serde(rename = "Heimerdinger_Passive.png")]
    HeimerdingerPassivePng,
    #[serde(rename = "Heimerdinger.png")]
    HeimerdingerPng,
    #[serde(rename = "HeimerdingerQ.png")]
    HeimerdingerQPng,
    #[serde(rename = "HeimerdingerR.png")]
    HeimerdingerRPng,
    #[serde(rename = "HeimerdingerW.png")]
    HeimerdingerWPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "HeimerdingerARAM")]
    HeimerdingerAram,
    #[serde(rename = "HeimerdingerCS")]
    HeimerdingerCs,
    #[serde(rename = "HeimerdingerFIRSTBLOOD")]
    HeimerdingerFirstblood,
    #[serde(rename = "HeimerdingerKINGPORO")]
    HeimerdingerKingporo,
    #[serde(rename = "HeimerdingerSIEGE")]
    HeimerdingerSiege,
    #[serde(rename = "HeimerdingerSL")]
    HeimerdingerSl,
    #[serde(rename = "HeimerdingerSR")]
    HeimerdingerSr,
    #[serde(rename = "HeimerdingerTT")]
    HeimerdingerTt,
}
