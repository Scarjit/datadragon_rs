...
pub fn serialize(json: &str) -> Result<RekSaiJson,Error>{
...
pub struct RekSaiJson {
    #[serde(rename = "type")]
    pub rek_sai_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "RekSaiE.png")]
    RekSaiEPng,
    #[serde(rename = "RekSai_Passive.png")]
    RekSaiPassivePng,
    #[serde(rename = "RekSai.png")]
    RekSaiPng,
    #[serde(rename = "RekSaiQ.png")]
    RekSaiQPng,
    #[serde(rename = "RekSaiRWrapper.png")]
    RekSaiRWrapperPng,
    #[serde(rename = "RekSaiW.png")]
    RekSaiWPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "RekSaiARAM")]
    RekSaiAram,
    #[serde(rename = "RekSaiCS")]
    RekSaiCs,
    #[serde(rename = "RekSaiFIRSTBLOOD")]
    RekSaiFirstblood,
    #[serde(rename = "RekSaiKINGPORO")]
    RekSaiKingporo,
    #[serde(rename = "RekSaiSIEGE")]
    RekSaiSiege,
    #[serde(rename = "RekSaiSL")]
    RekSaiSl,
    #[serde(rename = "RekSaiSR")]
    RekSaiSr,
    #[serde(rename = "RekSaiTT")]
    RekSaiTt,
}
