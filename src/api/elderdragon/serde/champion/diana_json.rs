...
pub fn serialize(json: &str) -> Result<DianaJson,Error>{
...
pub struct DianaJson {
    #[serde(rename = "type")]
    pub diana_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "DianaOrbs.png")]
    DianaOrbsPng,
    #[serde(rename = "Diana_Passive_LunarBlade.png")]
    DianaPassiveLunarBladePng,
    #[serde(rename = "Diana.png")]
    DianaPng,
    #[serde(rename = "DianaQ.png")]
    DianaQPng,
    #[serde(rename = "DianaTeleport.png")]
    DianaTeleportPng,
    #[serde(rename = "DianaVortex.png")]
    DianaVortexPng,
}
...
pub enum Title {
    Beginner,
    #[serde(rename = "DianaARAM")]
    DianaAram,
    #[serde(rename = "DianaCS")]
    DianaCs,
    #[serde(rename = "DianaFIRSTBLOOD")]
    DianaFirstblood,
    #[serde(rename = "DianaKINGPORO")]
    DianaKingporo,
    #[serde(rename = "DianaSIEGE")]
    DianaSiege,
    #[serde(rename = "DianaSL")]
    DianaSl,
    #[serde(rename = "DianaSR")]
    DianaSr,
    #[serde(rename = "DianaTT")]
    DianaTt,
}
