...
pub fn serialize(json: &str) -> Result<AurelionSolJson,Error>{
...
pub struct AurelionSolJson {
    #[serde(rename = "type")]
    pub aurelion_sol_json_type: GroupEnum,
    pub format: Format,
    pub version: Version,
    pub data: Data,
}
...
#[derive(Serialize, Deserialize)]
pub enum Full {
    #[serde(rename = "AurelionSolE.png")]
    AurelionSolEPng,
    #[serde(rename = "AurelionSol_Passive.png")]
    AurelionSolPassivePng,
    #[serde(rename = "AurelionSol.png")]
    AurelionSolPng,
    #[serde(rename = "AurelionSolQ.png")]
    AurelionSolQPng,
    #[serde(rename = "AurelionSolR.png")]
    AurelionSolRPng,
    #[serde(rename = "AurelionSolW.png")]
    AurelionSolWPng,
}
...
#[derive(Serialize, Deserialize)]
pub enum Title {
    #[serde(rename = "AurelionSolARAM")]
    AurelionSolAram,
    #[serde(rename = "AurelionSolBEGINNER")]
    AurelionSolBeginner,
    #[serde(rename = "AurelionSolCS")]
    AurelionSolCs,
    #[serde(rename = "AurelionSolFIRSTBLOOD")]
    AurelionSolFirstblood,
    #[serde(rename = "AurelionSolKINGPORO")]
    AurelionSolKingporo,
    #[serde(rename = "AurelionSolSIEGE")]
    AurelionSolSiege,
    #[serde(rename = "AurelionSolSL")]
    AurelionSolSl,
    #[serde(rename = "AurelionSolSR")]
    AurelionSolSr,
    #[serde(rename = "AurelionSolTT")]
    AurelionSolTt,
}

#[derive(Serialize, Deserialize)]
pub enum CooldownBurn {
    #[serde(rename = "110/90/70")]
    The1109070,
    #[serde(rename = "11/10/9/8/7")]
    The1110987,
    #[serde(rename = "80/75/70/65/60")]
    The8075706560,
